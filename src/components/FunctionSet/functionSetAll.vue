    ...
    <div class="page_content">
        <div class="div_content">
            ...
            <el-select
                ...
                :label-in-value="true"
                @change="changeScoreMold"
                clearable
                :disabled="disabled"
            >
                <el-option
                    v-for="item in scoreMoldType"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value"
                ></el-option>
            ...
            <el-input-number
                ...
                style="width: 180px;"
                clearable
                @input="numericalDecimalInput($event)"
        ...
        <span slot="footer" class="dialog-footer">
            <div class="tip-left" v-if="!noShowConfirmBtn">
                <el-button type="primary" @click="confirm">{{$i18ns('确定')}}</el-button>
                <el-button type="info" @click="cancel">{{$i18ns('取消')}}</el-button>
            </div>
        </span>
    </div>
</template>
    ...
    methods: {
        ...
        getFunctionList() {
            ...
            let params = {
                ...
                resultType,
                servicecode:
                    "risk-management-service/risk-function/page-select",
