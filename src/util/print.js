...
Print.prototype = {
  init: function (options) {
    ...
    this.writeIframe(content, options);
  },
  ...
  getStyle: function () {
    ...
    str += "<style>.print{width: 100%;}.table_left{display: none;}</style>";
    return str;
  },
  ...
  writeIframe: function (content, options) {
    var w,
      doc,
