    ...
    methods: {
      handleClick() {
        ...
        if (this.$dataBus.getCurrentScope(this).datagrid.length > 0) {
          ...
          request_map["pspyls"] = tableArry;
        }

        console.log('formData', formData);
        request_map["servicecode"] = "nxschd";
        request_map["custac"] = formData.custac;
        request_map["crcycd"] = formData.crcycd;
        request_map["tranam"] = formData.tranam;
        request_map["loandt"] = formData.loandt;
        request_map["period"] = formData.period+"M";
        request_map["matudt"] = formData.matudt;
        request_map["repyfm"] = formData.repyfm;
        request_map["schdtp"] = formData.schdtp;
        request_map["prodcd"] = formData.prodcd;
        request_map["irdyfg"] = formData.irdyfg;
        request_map["lnrtir"] = formData.lnrtir;
        request_map["sprdid"] = formData.sprdid;
        request_map["incftp"] = formData.incftp;
        request_map["frstmd"] = formData.frstmd;
