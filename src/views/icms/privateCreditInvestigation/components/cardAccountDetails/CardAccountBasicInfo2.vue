<template>
    <div class="cardAccount_basic_info_container">
        <div style="width: 100%;
          line-height: 23px;
          text-align: left;
          padding: 10px;
...
export default {
    ...
    created() {
        ...
        this.tip = '截至' + formatDate(3, this.tableData[0].report_date)+',账户状态为"未激活"';
        console.log("====================授信协议标识"+this.tableData[0].credit_protocol_no +',' + this.tableData[0].account_no);
    },
    methods: {
