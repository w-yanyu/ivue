  ...
  <div>
    <div class="todo-top">
      ...
      >
        <el-row>
          <el-col :span="8">
            <el-form-item :rules="[{ required: false, message: $i18ns('此项为必填项') }]" class="upload-item" :label="$i18ns('借据号')"
                          prop="loan_no">
          ...
          <el-col :span="8">
            ...
            :label="$i18ns('分期期数')"
              ...
              class="upload-item"
              :rules="[{ required: true, message: $i18ns('此项为必填项') }]"
            >
          ...
          <el-col :span="8">
            <el-form-item
              ...
              :rules="[{ required: true, message: $i18ns('此项为必填项') }]"
            >
              <scene-currency v-model="ruleForm.lend_amt" clearable @input="countBaseAmnt"></scene-currency>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item
              ...
              prop="exchange_rate"
              class="upload-item"
              :rules="[{ required: false, message: $i18ns('此项为必填项') }]"
            >
