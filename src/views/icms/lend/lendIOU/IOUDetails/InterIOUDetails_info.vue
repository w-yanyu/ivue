        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item
              ...
              :rules="[{ required: false, message: '此项为必填项' }]"
            >
              <el-input v-model="ruleForm.lend_amt" clearable :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="基准金额:" prop="base_amt" class="upload-item">
              <el-input v-model="ruleForm.base_amt" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="受托支付限额(折基准币种):" prop="trust_pay_amt" class="upload-item">
              <el-input v-model="ruleForm.trust_pay_amt" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
