  ...
  <div>
    <div class="todo-top">
      ...
      >
        <el-row>
          <el-col :span="8">
            <el-form-item :rules="[{ required: false, message: '此项为必填项' }]" class="upload-item" label="借据号:"
                          prop="loan_no">
              <el-input v-model="ruleForm.loan_no" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="还款间隔:" prop="repay_interval" class="upload-item">
              <el-select
          ...
          <el-col :span="8">
            <el-form-item label="利率调整模式:" prop="inst_rate_adjust_mode" class="upload-item">
              <el-select
          ...
          <el-col  :span="8">
            <el-form-item label="原放款日期" prop="start_inst_date">
              <el-date-picker
            ...
            <el-col  :span="8">
            <el-form-item label="原放款到期日" prop="matu_date">
              <el-date-picker
          ...
          <el-col :span="8" v-show="false">
            ...
            >
              <el-input v-model="ruleForm.installment_num"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item
         ...
         <el-col  :span="8">
            <el-form-item label="展期起息日" prop="extd_dt">
              <el-date-picker
                v-model="ruleForm.matu_date"
                align="right"
                type="date"
        ...
        <el-col :span="8">
            <el-form-item
              ...
              :rules="[{ required: false, message: '此项为必填项' }]"
            >
              <el-input v-model="ruleForm.ext_term"  :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        <el-col  :span="8">
            <el-form-item label="展期到期日" prop="end_date">
              <el-date-picker
          ...
          <el-col :span="8">
            <el-form-item
              ...
              class="upload-item"
            >
              <scene-currency v-model="ruleForm.lend_amt" :disabled="true"></scene-currency>
            </el-form-item>
          </el-col>
           ...
           <el-col :span="8">
            <el-form-item
              ...
              :rules="[{ required: false, message: '此项为必填项' }]"
            >
              <scene-currency v-model="ruleForm.ext_amt" clearable @input="countBaseAmnt" :disabled="true"></scene-currency>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="展期金额（基准）:" prop="ext_base_amt" class="upload-item">
              <scene-currency v-model="ruleForm.ext_base_amt" :disabled="true"></scene-currency>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="币种:" prop="ccy_code" class="upload-item">
              <el-select
          ...
          <el-col :span="8">
            <el-form-item
              ...
              :rules="[{ required: false, message: '此项为必填项' }]"
            >
              <el-input  v-model="ruleForm.exchange_rate" value="1" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8" v-show="false">
            <el-form-item label="基准金额:" prop="base_amt" class="upload-item">
          ...
          <el-col :span="8">
            <el-form-item
              label="原执行利率(%):"
              prop="orig_execution_inst_rate"
              class="upload-item"
            >
              <el-input v-model="ruleForm.orig_execution_inst_rate" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item
          ...
          <el-col :span="8" v-show="false">
            ...
            >
              <el-input v-model="ruleForm.overdue_inst_rate"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8" v-show="false">
            <el-form-item
              ...
              class="upload-item"
            >
              <el-input v-model="ruleForm.acct_branch"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8" v-show="false">
            <el-form-item
          ...
          <el-col :span="8" v-show="false">
            <el-form-item label="是否受托支付:" prop="trust_pay_limit_flag" class="upload-item">
              <el-select
          ...
          <el-col :span="8" v-show="false">
            <el-form-item label="受托支付限额(折基准币种):" prop="trust_pay_amt" class="upload-item">
              <scene-currency v-model="ruleForm.trust_pay_amt"></scene-currency>
            </el-form-item>
          </el-col>
          <el-col :span="8" v-show="false">
            <el-form-item
          ...
          <el-col :span="8" v-show="false">
            <el-form-item label="住房面积选项:" prop="house_area" class="upload-item">
              <el-select
          ...
          <el-col :span="8" v-show="false">
            <el-form-item label="银团贷款明细:" prop="club_loan_type" class="upload-item">
              <el-select
          ...
          <el-col :span="24" v-show="false">
            ...
            >
              <el-input
                ...
                @focus="clickLookupTree('loan_support_type','贷款财政扶持方式','5')"
                clearable
                @clear="clear('loan_support_type')"
              ></el-input>
              <el-input v-model="ruleForm.loan_support_type" v-show="false"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8" v-show="false">
            <el-form-item
          ...
          <el-col :span="24" v-show="false">
            ...
            >
              <el-input
                ...
                @focus="clickLookupTree('safe_live_code','保障性安居工程类型','4')"
                clearable
                @clear="clear('safe_live_code')"
              ></el-input>
              <el-input v-model="ruleForm.safe_live_code" v-show="false"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24" v-show="false">
            ...
            >
              <el-input
                ...
                @focus="clickLookupTree('loan_invest','保障性安居工程类型','1')"
                clearable
                @clear="clear('loan_invest')"
              ></el-input>
              <el-input v-model="ruleForm.loan_invest" v-show="false"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24" v-show="false">
            ...
            >
              <el-input
                ...
                @focus="clickLookupTree('restrict_encourage_new','限制或鼓励行业(新标准)','3')"
                clearable
                @clear="clear('restrict_encourage_new')"
              ></el-input>
              <el-input v-model="ruleForm.restrict_encourage_new" v-show="false"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      ...
      >
        <LookupTree ref="LookupTree" @closeDialog="closeDialog" :treeTitle="this.treeTitle"
                    :treeType="this.treeType" :inputName="this.inputName"></LookupTree>
      </el-dialog>
    </div>
  </div>
</template>
...
export default {
  ...
  watch: {
    ...
    //监听是否房地产开发借款
    'ruleForm.is_realty_deve_loan': {
      handler() {
        if (this.ruleForm.is_realty_deve_loan === this.is_YES) {
    ...
    //监听房地产开发类型
    'ruleForm.realty_deve_type': {
      handler() {
        if (this.ruleForm.realty_deve_type === "10201" || this.ruleForm.realty_deve_type === "10202") {
          this.isSafeLiveFlagStatus = true;
        } else {
          this.isSafeLiveFlagStatus = false;
          this.ruleForm.safe_live_code = "";
        }
      },
      immediate: true
    },
    ...
    //监听是否财政支持
    'ruleForm.is_support_flag': {
      handler() {
        if (this.ruleForm.is_support_flag === this.is_YES) {
          this.isLnSupportFlagStatus = true;
        } else {
          this.isLnSupportFlagStatus = false;
          this.ruleForm.loan_support_type = "";
        }
      },
      immediate: true
    },
    ...
    'ruleForm.loan_support_type': {
      handler() {
        let that = this;
        let loan_support_type = that.ruleForm.loan_support_type;
        if (typeof(loan_support_type) != "undefined" && loan_support_type !== "" && loan_support_type !== null) {
          let tree_type = "5";
          that.getTreeIDAndName(loan_support_type,tree_type,(data)=>{
            that.ln_support_type_name = data;
          });
        } else {
          that.ln_support_type_name = "";
        }
      },
      immediate: true
    },
    'ruleForm.safe_live_code': {
      handler() {
        let that = this;
        let safe_live_code = that.ruleForm.safe_live_code;
        if (typeof(safe_live_code) != "undefined" && safe_live_code !== "" && safe_live_code !== null) {
          let tree_type = "4";
          that.getTreeIDAndName(safe_live_code,tree_type,(data)=>{
            that.safe_live_name = data;
          });
        } else {
          that.safe_live_name = "";
        }
  ...
  methods: {
    ...
    //
    clickLookupTree(inputName,treeTitle,treeType) {
      this.inputName = inputName;
      this.treeTitle = treeTitle;
      this.treeType = treeType;
      console.log("树种类", this.treeType);
    ...
    closeDialog(item) {
      let that = this;
      if (item) {
        let nodeCd = item[0].node_cd;
        let inputName = that.inputName;
        that.ruleForm[inputName] = nodeCd;
        that.treeType = "";
        that.treeTitle = "";
    ...
    clear(name) {
      if (name === 'safe_live_code') {
        this.ruleForm.safe_live_code = "";
      }
      if (name === 'ln_invest_new') {
        this.ruleForm.ln_invest_new = "";
      }
      if (name === 'ln_invest') {
        this.ruleForm.ln_invest = "";
      }
      if (name === 'ln_ltwy_new_desc') {
        this.ruleForm.ln_ltwy_new_desc = "";
      }
      if (name === 'ln_support_type') {
        this.ruleForm.ln_support_type = "";
      }
    },
    //计算基准金额
    countBaseAmnt(){
      this.ruleForm.base_amt = String(this.ruleForm.lend_amt * this.ruleForm.exchange_rate);
      this.ruleForm.ext_base_amt = String(this.ruleForm.ext_amt * this.ruleForm.exchange_rate);
