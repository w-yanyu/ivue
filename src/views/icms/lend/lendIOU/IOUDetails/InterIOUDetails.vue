    ...
    <div class="todo-top">
      ...
      >
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="预期放款日期:" prop="lend_date" class="upload-item">
              <el-date-picker
                v-model="ruleForm.lend_date"
                type="date"
                placeholder="选择日期"
                format="yyyy-MM-dd"
          ...
          <el-col :span="8">
            <el-form-item label="第一次扣款日:" prop="first_ded_date" class="upload-item">
              <el-date-picker
                v-model="ruleForm.first_ded_date"
                type="date"
                placeholder="选择日期"
                format="yyyy-MM-dd"
                value-format="yyyyMMdd">
          ...
          <el-col :span="8">
            <el-form-item
              ...
              :rules="[{ required: true, message: '此项为必填项' }]"
            >
              <el-input v-model="ruleForm.lend_amt" clearable></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="放款币种:" prop="ccy_code" class="upload-item">
              <el-select
          ...
          <el-col :span="8">
            <el-form-item label="基准金额:" prop="base_amt" class="upload-item">
              <el-input v-model="ruleForm.base_amt"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item
              ...
              class="upload-item"
            >
              <el-input v-model="ruleForm.subj_no"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="受托支付限额(折基准币种):" prop="trust_pay_amt" class="upload-item">
              <el-input v-model="ruleForm.trust_pay_amt"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
export default {
  ...
  created() {
    ...
    this.getLoanDetails(this.cParentParams.apply_no);//根据申请书编号查询放款明细
