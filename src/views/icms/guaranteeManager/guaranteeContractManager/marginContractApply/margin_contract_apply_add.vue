      ...
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="130px" class="custom-common--form">
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$i18ns('担保规则')" prop="guar_rule" label-width="203px">
              <el-select v-model="ruleForm.guar_rule" :placeholder="$i18ns('请选择担保规则')" @change="changeNameValue" disabled="true">
          ...
          <el-col :span="12">
            <el-form-item :label="$i18ns('本次使用金额')" prop="this_use_amt" label-width="203px">
              <el-input class="input_el" v-model.number="ruleForm.this_use_amt" :placeholder="$i18ns('请输入本次使用金额')"
                @blur="secOccupyAmtInput($event)" type="number" disabled="true"></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item :label="$i18ns('合同起始日期')" prop="guar_start_date" label-width="203px">
              ...
              <el-date-picker class="int" v-model="ruleForm.guar_start_date" :picker-options="startDatePicker" type="date"
                :placeholder="$i18ns('起始日期')" format="yyyyMMdd" value-format="yyyyMMdd" style="width: 100%">
              </el-date-picker>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item :label="$i18ns('合同到期日期')" prop="guar_end_date" label-width="203px">
              ...
              <el-date-picker class="int" v-model="ruleForm.guar_end_date" :picker-options="endDatePicker" type="date"
                :placeholder="$i18ns('结束日期')" format="yyyyMMdd" value-format="yyyyMMdd" style="width: 100%">
              </el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-table ref="multipleTable" :data="tableData" highlight-current-row tooltip-effect="dark" style="width: 100%"
            ...
            <el-table-column prop="ccy_code" :label="$i18ns('保证金币种')" align="center" :formatter="guarCcyFormat">
            </el-table-column>
            <el-table-column prop="account_name" :label="$i18ns('账户名称')" align="center">
            </el-table-column>
            <!-- <el-table-column prop="open_acct_branch" label="账户开户机构 " align="center">
            </el-table-column> -->
          </el-table>
...
export default {
  ...
  mounted() {
    ...
    that.initData();
    that.initDefineData();
    that.initsecCcyOptions("MS_CURRENCY", "ccy_codeOptions");
  ...
  */
    ...
    //加载字典
    initsecCcyOptions(dictType, dictKey) {
      let request_map = {};
    ...
    clickConfirm() {
      ...
      request_map["servicecode"] = "ar0421";
      request_map["apply_no"] = that.cParentParams.apply_no;
