    ...
    <div class="menu-form--container">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="130px" class="custom-common--form">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="$i18ns('担保类型')" prop="guar_modality" label-width="203px">
              <el-select v-model="ruleForm.guar_modality" :placeholder="$i18ns('请选择担保类型')" @change="changeGuarTypeValue">
          ...
          <el-col :span="12">
            <el-form-item :label="$i18ns('币种')" prop="ccy_code " label-width="203px">
              <el-select v-model="ruleForm.ccy_code" :placeholder="$i18ns('请选择币种')" @change="changeStatusValue">
          ...
          <el-col :span="12">
            <el-form-item :label="$i18ns('合同签订日期')" prop="sign_date" label-width="203px">
              <el-date-picker v-model="ruleForm.sign_date" type="date" :placeholder="$i18ns('选择日期')" format="yyyyMMdd" value-format="yyyyMMdd" style="width: 100%">
              </el-date-picker>
            </el-form-item>
          </el-col>
        ...
        <el-row class="menu-footer">
          <el-col :span="24">
            <el-button type="primary" @click="clickConfirm">{{$i18ns('提交')}}</el-button>
  ...
  export default {
    ...
    methods: {
        ...
        this.$http
          ...
          .then((response) => {
            if (response.code === "200") {
              ...
              this.ruleForm.ccy_code=this.ccy_codeOptions[0].dictId;
      ...
      clickConfirm() {
        ...
        request_map["servicecode"] = "ar0321";
        request_map["apply_no"] = that.cParentParams.apply_no;
        ...
        request_map["base_ccy"] = that.ruleForm.ccy_code;
