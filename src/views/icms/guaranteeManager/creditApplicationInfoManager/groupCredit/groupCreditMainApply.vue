  ...
  <div>
      <el-collapse v-model="activeNames">
        <el-collapse-item name="1">
          ...
          <to-json
            toUrl="/views/icms/guaranteeManager/creditApplicationInfoManager/credit_Main_Allocation.json"
            :params="pageParams"
          ></to-json>
        </el-collapse-item>
        <el-collapse-item name="2">
          ...
          <to-json
            toUrl="/views/icms/guaranteeManager/creditApplicationInfoManager/groupCredit/group_credit_tree.json"
            :params="pageParams"
          ></to-json>
        </el-collapse-item>
      </el-collapse>
