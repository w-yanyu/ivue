  ...
  <div class="menu-form">
    <div class="menu-form--container">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="130px" class="custom-common--form">
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$i18ns('担保合同号')" prop="colt_contract_no" label-width="203px">
              <el-input class="input_el" v-model="ruleForm.guar_contract_no">
              </el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item :label="$i18ns('被担保客户编号')" prop="debt_cust_no" label-width="203px">
        ...
        <el-row class="menu-footer" :span="12" style="text-align: center">
          <el-button type="primary" @click="clickConfirm">{{$i18ns('查询')}}</el-button>
        ...
        <el-row>
          <div class="divTitle">$i18ns('保证合同申请'):</div>
          ...
          <el-table ref="multipleTable" :data="tableData" highlight-current-row tooltip-effect="dark"
                    ...
                    v-loading="loading">
            <el-table-column prop="guar_contract_no" :label="$i18ns('保证合同号') " width="160" align="center"
                             :show-overflow-tooltip="true">
              <!-- <template slot-scope="scope">{{ scope.row.appt_no }}</template> -->
            </el-table-column>
            <el-table-column prop="max_contract_no" :label="$i18ns('最高额担保合同号')" width="160" align="center" v-if="maxGuarIsShow"
                             :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="debt_cust_name" :label="$i18ns('被担保人')" align="center" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="guar_cust_name" :label="$i18ns('担保人') " align="center" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="guar_rule" :label="$i18ns('担保规则')" align="center" :formatter="guarRuleFormat"
                             :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="contract_amt" :label="$i18ns('合同金额')" align="center" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="contract_bal" :label="$i18ns('合同余额')" align="center" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="base_ccy" :label="$i18ns('基准币种')" align="center" :formatter="cyyFormat"
                             :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="guar_start_date" :label="$i18ns('起始日期')" align="center" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column prop="guar_end_date" :label="$i18ns('到期日期')" align="center" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column
              align="center"
              :label="$i18ns('操作')"
...
export default {
  ...
  methods: {
    ...
    openContactDialog(index, row) {
      let that = this;
      let pageParams = row;
      pageParams.guar_type = "1";
      pageParams.type = "2";
      pageParams.guar_contract_type = "2"
      const option = {
        toRequest: {
          url1: "/views/icms/guaranteeManager/guaranteeContractManager/guarContractApply/guarantyContractlApplyDetail/guar_contract_apply_detail.json",
          url: "@linkMaxContract",
          method: "get",
          params: pageParams
        },
