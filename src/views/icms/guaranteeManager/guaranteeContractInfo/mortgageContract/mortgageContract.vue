  ...
  <div class="menu-form">
    <div class="menu-form--container">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="130px" class="custom-common--form">
        <el-row>
          <el-col :span="12">
            <el-form-item :label="$i18ns('担保合同号')" prop="colt_contract_no" label-width="203px">
              <el-input class="input_el" v-model="ruleForm.colt_contract_no">
              </el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <div class="divTitle">{{$i18ns('抵押合同申请')}}:</div>
          ...
          <el-table ref="multipleTable" :data="tableData" highlight-current-row tooltip-effect="dark"
                    ...
                    v-loading="loading">
            <el-table-column prop="colt_contract_no" :label="$i18ns('抵押合同号') " width="160" align="center"
...
export default {
  ...
  methods: {
    ...
    openContactDialog(index, row) {
      let that = this;
      let pageParams = row;
      pageParams.guar_type = "2";
      pageParams.type = "2";
      pageParams.guar_contract_type = "0"
      const option = {
        toRequest: {
          url: "@linkMaxContract",
          method: "get",
