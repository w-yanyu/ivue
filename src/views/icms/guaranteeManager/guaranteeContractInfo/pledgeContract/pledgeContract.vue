  ...
  <div class="menu-form">
    <div class="menu-form--container">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="130px" class="custom-common--form">
        ...
        <el-row>
          <div class="divTitle">$i18ns('质押合同申请'):</div>
          ...
          <el-table ref="multipleTable" :data="tableData" highlight-current-row tooltip-effect="dark"
                    ...
                    v-loading="loading">
            <el-table-column prop="colt_contract_no" :label="$i18ns('质押合同号') " width="160" align="center"
...
export default {
  ...
  methods: {
    ...
    openContactDialog(index, row) {
      let that = this;
      let pageParams = row;
      pageParams.guar_type = "3";
      pageParams.type = "2";
      pageParams.guar_contract_type = "1"
      const option = {
        toRequest: {
          url: "@linkMaxContract",
          method: "get",
