<template>
  <div>
    <el-form ref="orderForm" :rules="rules" :model="orderForm" label-width="200px" class="custom-common--form">
      <el-row>
        <el-col :span="8" v-if="false">
          <el-form-item class="require-asterisk" :label="$i18ns('供应商编号')" prop="supplier_no">
            <el-input type="text" v-model="orderForm.supplier_no" readonly="readonly" disabled>
              <el-button slot="append" icon="el-icon-search" @click="qryPartnerList" disabled></el-button>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8" v-if="false">
          <el-form-item class="require-asterisk" :label="$i18ns('车型编号')" prop="car_model_no">
            <el-input type="text" v-model="orderForm.car_model_no" readonly="readonly">
              <el-button slot="append" icon="el-icon-search" @click="qryCarModelList"></el-button>
            </el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8" v-if="false">
          <el-form-item class="require-asterisk" :label="$i18ns('品牌编号')" prop="brand_no">
            <el-input type="text" v-model="orderForm.brand_no" disabled></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8" v-if="false">
          <el-form-item class="require-asterisk" :label="$i18ns('车系编号')" prop="car_kind_no">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('供应商名称')" prop="supplier_name">
            <el-input type="text" v-model="orderForm.supplier_name" disabled></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('受托支付账号')" prop="payee_acct_no">
        ...
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('车型名称')" prop="car_model_name">
            <el-input type="text" v-model="orderForm.car_model_name" disabled></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('厂商指导价')" prop="price">
            <el-input type="text" v-model="orderForm.price" disabled></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('品牌名称')" prop="brand_name">
            <el-input type="text" v-model="orderForm.brand_name" disabled></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('车系名称')" prop="car_kind_name">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('车身结构')" prop="sizetype">
            <el-input type="text" v-model="orderForm.sizetype" disabled></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('排量')" prop="displacement2">
            <el-input type="text" v-model="orderForm.displacement2" disabled></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('变速箱类型')" prop="geartype">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('车身颜色')" prop="color">
        ...
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('采购数量')" prop="purch_volume">
            <el-input type="text" v-model="orderForm.purch_volume"
                      @input="handleVolumeChange"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('采购单价')" prop="purch_amount">
        ...
        <el-col :span="8">
          <el-form-item class="require-asterisk" :label="$i18ns('采购总价')" prop="purch_total_amount">
    ...
    <el-dialog :title="$i18ns('查询车型信息')" :visible.sync="carModelVisible" v-if="carModelVisible" width="70%"
               :before-close="handleClose"
               top="30vh"
               v-dialogDrag>
      <to-json
    ...
    <el-dialog :title="$i18ns('颜色选择器')" :visible.sync="colorSelectorVisible" v-if="colorSelectorVisible" width="20%"
               :before-close="handleClose"
               top="30vh"
               v-dialogDrag>
      <ColorSelector
    ...
    <el-dialog :title="$i18ns('选择受托支付账号')" :visible.sync="acctVisible" v-if="acctVisible" width="70%"
               :before-close="handleClose"
               top="30vh"
               v-dialogDrag>
      <to-json
...
export default {
  ...
  data() {
    ...
    return {
      ...
      partnerQryUrl: "/views/pt/partnerManage/ptbWarnInfo/ptPartner_list_lookup.json",
  ...
  created() {
    this.$dataBus.bindCallBackMethod(this, this.carModelCallback, {});
    this.$dataBus.bindCallBackMethod(this, this.acctCallback, {});
    // this.orderForm = this.cParentParams;
    Object.assign(this.orderForm,this.cParentParams);
    this.orderForm.purch_amount = this.handleDecimal(this.orderForm.purch_amount);
  },
  methods: {
    getRequest(url) {
      let obj = {};
    ...
    submit(){
      ...
      that.$refs.orderForm.validate(valid => {
        if (valid) {
          console.log("当前维护页面传入数据前",this.orderForm);
          that.$emit("modifyCarModelCallBack", this.orderForm);
        } else {
          this.$message({
            type: "warning",
            message: "校验不通过",
