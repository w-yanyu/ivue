    ...
    <div class="menu-form--container">
      <el-form ref="applyForm" :model="applyForm" :rules="rules" label-width="130px" class="custom-common--form">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="贷款用途" label-width="195px">
              <div class="lookupDiv">
        ...
        <div class="menu-form--title-min">身份信息</div>
        <el-row>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="是否有工作单位" prop="is_work" label-width="195px">
              <div class="lookupDiv">
                <el-select v-model="applyForm.is_work" clearable placeholder="请选择是否有工作单位" @change="workEvent">
                  <el-option
          ...
          <el-col :span="8">
            <el-form-item label="单位性质" prop="unit_nature" v-if="workVisible" label-width="195px">
              <div class="lookupDiv">
                <el-select v-model="applyForm.unit_nature" clearable placeholder="请选择单位性质">
                  <el-option
          ...
          <el-col :span="8">
            <el-form-item label="申请人年收入(元)" prop="year_income" v-if="workVisible" label-width="195px">
              <div class="lookupDiv">
          ...
          <el-col :span="8">
            <el-form-item label="年收入币种" prop="busi_unit_income_ccy" v-if="workVisible" label-width="195px">
              <div class="lookupDiv">
                <el-select v-model="applyForm.busi_unit_income_ccy" disabled="true" clearable placeholder="请选择年收入币种">
                  <el-option
          ...
          <el-col :span="8">
            <el-form-item label="婚姻状况" prop="marr_state" label-width="195px">
              <div class="lookupDiv">
                <el-select v-model="applyForm.marr_state" clearable placeholder="请选择婚姻状况" @change="marriageEvent">
                  <el-option
          ...
          <el-col :span="8">
            <el-form-item label="配偶姓名" prop="spouse_name" v-if="spouseVisible" label-width="195px">
              <div class="lookupDiv">
          ...
          <el-col :span="8">
            <el-form-item label="配偶证件类型" prop="spouse_cert_type" v-if="spouseVisible" label-width="195px">
              <div class="lookupDiv">
                <el-select v-model="applyForm.spouse_cert_type" clearable placeholder="请选择配偶证件类型">
                  <el-option
          ...
          <el-col :span="8">
            <el-form-item label="配偶证件号码" prop="spouse_cert_no" v-if="spouseVisible" label-width="195px">
              <div class="lookupDiv">
          ...
          <el-col :span="8">
            <el-form-item label="配偶工作单位名称" prop="spouse_work_unit_name" v-if="spouseVisible" label-width="195px">
              <div class="lookupDiv">
          ...
          <el-col :span="8">
            <el-form-item label="配偶工作单位电话" prop="spouse_work_phone" v-if="spouseVisible" label-width="195px">
              <div class="lookupDiv">
        ...
        <div class="menu-form--title-min">房屋信息</div>
        <el-row>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="建筑面积信息(平米)" prop="area_msg" label-width="195px">
              <div class="lookupDiv">
          ...
          <el-col :span="8">
            <el-form-item label="锁定房屋基准经纬度信息：" prop="longitude" label-width="195px">
                  ...
                  <el-button size="small" type="primary" @click="positionLookup">打开地图锁定</el-button>
            </el-form-item>
          </el-col>
          <el-col :span="8">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        longitude: [
          {required: true, message: '请上传房屋中心图片锁定基准房屋经纬度信息', trigger: 'blur'}
        ],
      },
      startDatePicker: this.beginDate(),
      endDatePicker: this.processDate(),
      productQueryCondition: {},
      productLookupURL: "/views/icms/flowStart/noncredit_sell_product_lookup.json",
  ...
  created() {
    ...
    this.getDictList("AR_E_LOAN_PURPOSE", "loanUseOptions");
  ...
  methods: {
    ...
    flowStart() {
      let request_map = {};
      request_map["servicecode"] = "ar1012";
      let conditon = {};
