            ...
            <el-row>
              <el-col :span="12">
                <el-form-item :label="$i18ns('备注')">
                  <el-input type="textarea" :disabled="true" :autosize="{minRows:2, maxRows: 5}" placeholder="请输入备注" v-model="appForm.remark"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
console.info("this.basicForm====",this.basicForm);
