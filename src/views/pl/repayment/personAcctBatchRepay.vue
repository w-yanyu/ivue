        ...
        >
          <el-row>
            <el-col :span="5">
              <el-form-item label="批次号" prop="batch_no">
                <el-input v-model="queryForm.batch_no"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="借据号" prop="loan_no">
                <el-input v-model="queryForm.loan_no"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="客户姓名" prop="cust_name">
                <el-input v-model="queryForm.cust_name"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="证件号码" prop="cert_no">
                <el-input v-model="queryForm.cert_no"></el-input>
              </el-form-item>
            </el-col>
          ...
          <el-row style="margin-top:20px;">
            <el-table :data="tableData">
              <el-table-column label="批次号" align="center" prop="batch_no"></el-table-column>
              <el-table-column label="借据号" align="center" prop="loan_no"></el-table-column>
              <el-table-column label="客户姓名" align="center" prop="cust_name"></el-table-column>
              <el-table-column label="证件号码" align="center" prop="cert_no"></el-table-column>
              <el-table-column label="产品名称" align="center" prop="prod_name"></el-table-column>
              <el-table-column label="逾期天数" align="center" prop="overdue_days"></el-table-column>
              <el-table-column label="贷款形态" align="center" prop="loan_form"></el-table-column>
              <el-table-column label="核销状态" align="center" prop="chk_write_off_ste"></el-table-column>
              <el-table-column label="扣款状态" align="center" prop="refund_ddc_mny_ste"></el-table-column>
              <el-table-column label="还款状态" align="center" prop="rpymt_ste"></el-table-column>
              <el-table-column label="还款金额" align="center" prop="rpymt_amt"></el-table-column>
              <el-table-column label="实际还款金额" align="center" prop="actl_rpymt_amt"></el-table-column>
