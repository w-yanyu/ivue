        ...
        <div class="el-dialog-dev">
                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="机构名称" prop="branch_name">
                                <el-input v-model="orgForm.branch_name" class="input"></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                            <el-form-item label="合作状态" prop="mech_status">
                                <el-select v-model="orgForm.mech_status" placeholder="请选择合作状态" :disabled="mechsStatusList.length==1" clearable="true">
                                    <el-option
            ...
            <div class="container-centent--table">
                <el-table ref="cooOrgTable" :data="cooOrgTable" row-key="oa_org_id" :border="true" style="width: 98%;" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="机构号" prop="branch_id" align="center">
                    </el-table-column>
    ...
    methods: {
       ...
       */
        ...
        */
        getTableData() {
            let reqMap = {
                branch_id:this.orgForm.branch_id,
                orgType: this.orgForm.org_type,
                branch_name: this.orgForm.branch_name,
                mech_status: this.orgForm.mech_status,
                servicecode: "pl0604",
            ...
            this.$refs.appForm.validate(valid => {
                if (valid) {
                    ...
                    type: "warning"
                        ...
                        let params = {
                            servicecode: "pl0605",
                            branch_id:this.appForm.branch_id,
        ...
        addOrg(){
            if(this.multipleSelection.length === 0){
                ...
                for (var i=0; i<selectionLen; i++){
                    let selArr ={
                        astatus:true,
                        branch_id:arr[i].branch_id,
                        orgType:arr[i].orgType,
                        branch_name:arr[i].branch_name,
       ...
       */
        saveAllRow(){
          ...
          for (let i = 0;i < this.appForm.tableData.length;i++) {
            ...
            if(!item.branch_name || item.branch_name.length===0){
              this,saveStatus = false;
              break;
            }
