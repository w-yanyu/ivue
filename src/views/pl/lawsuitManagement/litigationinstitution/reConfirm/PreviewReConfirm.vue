        ...
        <el-collapse-item name="3">
          ...
          <el-form ref="reConForm" :rules="reConRules" :model="reConForm" label-width="250px" class="custom-common--form">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item class="require-asterisk" label="执业许可证（正副本）/营业执照">
                  <upload-file ref="yyzzProp" :uploadFileList="reConForm.yyzz" :uploadDisabled="true"
                      @changeFile="reConyyzzChange" :key="timer" :isOrNoHidden="true"></upload-file>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item class="require-asterisk" label="外包诉讼协议" prop="wbssxy">
                  <upload-file ref="wbssxyProp" :uploadFileList="reConForm.wbssxy" :uploadDisabled="true"
                      @changeFile="reConWbssxyChange" :key="timer" :isOrNoHidden="true"></upload-file>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item class="require-asterisk" label="法律意见审定表" prop="flyjsdd">
                  <upload-file ref="flyjsddProp" :uploadFileList="reConForm.flyjsdd" :uploadDisabled="true"
                      @changeFile="reConFlyjsddChange" :key="timer" :isOrNoHidden="true"></upload-file>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item class="require-asterisk" label="廉洁合作承诺书" prop="ljhzcns">
                  <upload-file ref="ljhzcnsProp" :uploadFileList="reConForm.ljhzcns" :uploadDisabled="true"
                      @changeFile="reConLjhzcnsChange" :key="timer" :isOrNoHidden="true"></upload-file>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item :label="$i18ns('备注:')" prop="remark">
                  <el-input type="textarea" resize="none" v-model="reConForm.remark" autosize="true" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
