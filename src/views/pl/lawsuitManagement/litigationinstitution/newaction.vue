  ...
  <div>
    <div>
      <el-collapse v-model="activeNames">
        ...
        <el-row>
        <el-col :span="8">
                <el-form-item class="require-asterisk" label="引进材料" prop="cgcl">
         ...
         <el-row>
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="机构批量导入" prop="cgqd">
              ...
              <el-col :span="8">
                <el-button size="small"  class="container-centent" type="primary" @click="download">模板导出</el-button>
              </el-col>
        </el-row>
        <el-row>
           <el-col :span="8">
                <el-form-item label="其他附件" prop="cgpstzs">
                  <upload-file ref="cgpstzsProp" :uploadFileList="appForm.cgpstzs" :uploadDisabled="false" @changeFile="cgpstzsChange" :key="timer"></upload-file>
                </el-form-item>
              </el-col>
        </el-row>
