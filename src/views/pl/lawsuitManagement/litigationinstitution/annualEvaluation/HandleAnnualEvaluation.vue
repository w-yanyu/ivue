...
<script>
  ...
  export default {
    ...
    methods: {
       ...
       */
      addWatch(){
        this.unWatch.push(this.$watch("evalForm",function(){this.isHandleChange = true;},{deep:true}));
      },
      initRule(){
        this.evalRules = {
