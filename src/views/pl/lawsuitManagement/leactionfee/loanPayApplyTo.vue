        ...
        <el-collapse-item name="3">
          ...
          <el-form ref="appForm" :rules="appRules" :model="appForm" label-width="250px" class="custom-common--form">
            <el-row style="text-align:left;color:red">
              <el-col :span="24">
              <el-form-item  label="">
                <span slot="label" style="text-align:left;color:red">提示：</span>
                <span>①请优先缴纳诉讼费，如确有必要请注明原因<br/></span>
                <span>②如果存在相同费用类型的缴费已在流程中，需要核实确认，如需申请请注明原因<br/></span>
                <span>③如果收款账户与当前委案机构不一致，需要核实确认，如需申请请注明原因<br/></span>
              </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="8">
                <el-form-item  label="案号" prop="case_no" v-show="false">
                  <el-input v-model="appForm.case_no" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="费用类型:" prop="fee_type" >
                  <el-select v-model="appForm.fee_type" @change="feeTypeChange" :disabled="true">
              ...
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="付款金额" prop="pay_amount" >
                  <el-input ref="amount" v-model="appForm.pay_amount" v-bind:class="{ redActive: isRedActive,} " :disabled="true"  ></el-input>
                </el-form-item>
              </el-col>
            ...
            <el-row>
              <!-- <el-col :span="8">
                <el-form-item class="require-asterisk" label="收款方类型:" prop="rece_account_type">
                  <el-select v-model="appForm.rece_account_type"  placeholder=" " @change="payfeeTypeChange">
                    <el-option v-for="item in accountTypeList" :key="item.dictId" :label="item.dictName"  :disabled="true"
                               :value="item.dictId"/>
                  </el-select>
                </el-form-item>
              </el-col> -->
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="收款账户账号" prop="rece_accno">
                  <el-input v-model="appForm.rece_accno" :disabled="true">
                    <el-button slot="append" icon="el-icon-search" type="primary" @click="searchAccount" :disabled="true" plain>{{$i18ns('选择')}}</el-button>
                  </el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="收款账户名称:" prop="acct_name">
                  <el-input v-model="appForm.acct_name" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="开户行:" prop="other_acct_bank_name">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="垫付情况:" prop="adv_pay_status" :disabled="true">
                  <el-radio-group v-model="appForm.adv_pay_status">
                    <el-radio v-for="(item,i) in advPayStatusList" :key="i" :label="item.dictId" @change="radioChange" :disabled="true">
                      {{item.dictName}}
                    </el-radio>
                  </el-radio-group>
                </el-form-item>
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="其他附件" prop="fileList" v-show="false">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="支付凭证" prop="zfpz" v-show="false">
            ...
            <el-row>
              <el-col :span="16">
                <el-form-item label="打款附言:" prop="pay_remark">
                  <el-input type="textarea" maxlength="200" v-model="appForm.pay_remark" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              ...
              <el-col :span="16" v-show="remarkShow||remarkShowot||remarkShowft">
                <el-form-item  :label="$i18ns('备注:')" class="require-asterisk" prop="remarkot">
                  <el-input type="textarea" maxlength="200" v-model="appForm.remarkot" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
        ...
        <div class="container-content">
          ...
          <div class="container-centent--table">
            <el-table ref="multipleTable" :data="tableData" :border="true" style="width: 100%" stripe>
              <el-table-column label="账户类型" prop="acct_type"  align="center"></el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.getDictList("PL_E_ACCOUNT_TYPE", "accountTypeList"); // 账户类型
    ...
    methods: {
      initRule() {
        this.appRules = {
          ...
          remarkot: [{validator:this.remarkotValidate, message: "请输入备注",trigger: 'blur'}],
        }
      },
      lncfnoBlur() {
    ...
    MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
      .then((res) => {
        if (res && res.code === "200") {
         ...
         this.appForm.case_no = res.data.case_no;
          this.appForm.fee_type = res.data.fee_type;
          this.appForm.pay_amount = res.data.pay_amount;
          this.appForm.rece_account_type = res.data.rece_account_type;
          this.appForm.rece_accno = res.data.rece_accno;
          this.appForm.acct_name = res.data.acct_name;
          this.appForm.rece_org_name = res.data.rece_org_name;
          this.appForm.other_acct_bank_name = res.data.other_acct_bank_name;
          this.appForm.bank_no = res.data.bank_no;
          this.appForm.adv_pay_status = res.data.adv_pay_status;
          this.appForm.pay_remark = res.data.pay_remark;
