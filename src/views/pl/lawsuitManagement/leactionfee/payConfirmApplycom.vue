       ...
       <el-collapse-item name="2">
        ...
        <el-collapse-item name="3">
          ...
          <el-table ref="modifyTable" :data="tableModifyData" :border="true" @selection-change="handleSelection" stripe>
            ...
            <el-table-column :label="$i18ns('缴费申请单号')" prop="apply_no" align="center" show-overflow-tooltip>
              <template slot-scope="scope">
                <span>{{scope.row.apply_no}}</span>
              </template>
            </el-table-column>
            <el-table-column :label="$i18ns('费用类型')" prop="fee_type" align="center" :formatter="formatFeeTypeData" show-overflow-tooltip>
              <!-- <template slot-scope="scope">
                <span>{{scope.row.fee_type}}</span>
              </template> -->
            </el-table-column>

            <el-table-column :label="$i18ns('付款金额')" prop="pay_amount" align="center">
              <template slot-scope="scope">
                <span>{{scope.row.pay_amount}}</span>
              </template>
            </el-table-column>
            <el-table-column :label="$i18ns('客户承担')" prop="cust_amt" align="center">
              <template slot-scope="scope">
            ...
            <el-table-column :label="$i18ns('法院退回')" prop="court_back_amt" align="center">
              <template slot-scope="scope">
            ...
            <el-table-column :label="$i18ns('公司承担')" prop="compnay_amt" align="center">
              <template slot-scope="scope">
            ...
            <el-table-column :label="$i18ns('操作')" align="center">
              <template slot-scope="scope">
                <el-button type="text" icon="el-icon-edit" @click="scope.row.status=true">{{$i18ns('修改')}}</el-button>
                <el-button type="text" icon="el-icon-check" @click="saveRow(scope.$index,scope.row)">{{$i18ns('确认')}}</el-button>
              </template>
            </el-table-column>
          </el-table>
          <div class="space"></div>
            ...
            <el-row>
              ...
              <el-col :span="18" >
                <el-form-item  :label="$i18ns('备注:')" prop="remark">
                  <el-input type="textarea" maxlength="200" v-model="appForm.remake"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
