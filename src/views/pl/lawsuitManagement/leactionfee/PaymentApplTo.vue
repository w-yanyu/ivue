        ...
        >
          <el-row>
            <el-col :span="8">
              ...
              >
                <el-select v-model="debtForm.expense_type" placeholder=" " :disabled="true" @change="expenseChange">
                  <el-option
            ...
            <el-col :span="8" v-if="debtForm.expense_type === '1'">
              <el-form-item label="客户回款合计" prop="custAmountTotal">
          ...
          <el-row>
            <el-col :span="8" v-if="debtForm.expense_type === '1'">
              ...
              >
                <el-input v-model="debtForm.settlement_amount_total" :disabled="true" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item
                ...
                class="require-asterisk"
              >
                <el-input ref="amount" v-model="debtForm.pay_amount" v-bind:class="{ redActive: isRedActive,}" :disabled="true"  ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item
              ...
              >
                <el-select v-model="debtForm.acctno_type" placeholder=" " :disabled="true" @change="payfeeTypeChange">
                  <el-option
            ...
            <el-row>
              <el-col :span="8" class="sel-button">
                <el-button type="primary" size="small" :disabled="true" @click="selAccount">{{$i18ns('选择')}}收款账户</el-button>
              </el-col>
              <el-col :span="8">
          ...
          <div class="input-account-form">
            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="开户行" prop="bank_no" >
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item
                ...
                prop="clen_mode"
              >
                <el-select v-model="debtForm.clen_mode" placeholder=" "  :disabled="true" >
                  <el-option
...
export default {
 ...
 //   UploadFile,
  ...
  methods: {
     ...
     */
    dateCheckOut() {
      console.log("this.basicForm.nowvorgnm===", this.basicForm.nowvorgnm, this.basicForm.nowvtime);
      if (this.basicForm.nowvorgnm !== "" && this.basicForm.nowvorgnm !== undefined && this.basicForm.nowvorgnm !== null) {
        //结算开始时间必须大于当前委案时间
        ...
        if (this.temdate === "") {
          ...
          console.log("this.temdate22222222222",this.temdate);
          this.pickerOptions.disabledDate = time => {
    ...
    MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
      .then((res) => {
        if (res && res.code === "200") {
         ...
         this.debtForm.expense_type = res.data.expense_type;
         this.debtForm.pay_amount = res.data.pay_amount;
         this.debtForm.acctno_type = res.data.acctno_type;
         this.debtForm.rece_accno = res.data.rece_accno;
         this.debtForm.acct_name = res.data.acct_name;
         this.debtForm.bank_name = res.data.bank_name;
         this.debtForm.bank_no = res.data.bank_no;
         this.debtForm.clen_mode = res.data.clen_mode;
         this.debtForm.pay_remark = res.data.pay_remark;
         this.debtForm.remark = res.data.remark;
         this.debtForm.settlement_amount_total = res.data.settlement_amount_total;
    ...
    getAccTableData() {
      let params = {
        servicecode: "pl0550",
        acct_type: this.debtForm.acctno_type, //账户类型
