<template>
  <div>
    <el-collapse v-model="activeNames" class="custom-common--collapse">
      ...
      <el-collapse-item name="2">
        <template slot="title">
          ...
          <div class="warn-class">提示：该笔案件收案后，不可向该机构进行该案的缴费！</div>
        </template>
        <el-form
          ref="applyForm"
          :rules="rules"
        ...
        >
          <el-row>
            <el-col :span="8">
              <el-form-item label="当前委案机构" prop="entrorg_name">
                <el-input v-model="applyForm.entrorg_name" :disabled="true" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="收案原因" prop="back_reason" >
                <el-select v-model="applyForm.back_reason" placeholder :disabled="true">
                  <el-option
    ...
    <div class="custom-common--footer">
      <el-button type="primary" size="small" @click="checkAll('submit')" :disabled="sfPressbut" v-show="false">提交</el-button>
    ...
    MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
      .then((res) => {
        if (res && res.code === "200") {
          ...
          this.applyForm.back_reason = res.data.back_reason;
