            ...
            <el-row>
              <el-col :span="12">
                <el-form-item label="借据号" prop="lncfno">
                  <el-input v-model="basicForm.lncfno" oninput="value=value.replace(/[^\d]/g,'')" maxlength='30' @blur="infoGet($event)"></el-input>
                </el-form-item>
                ...
                <el-form-item label="贷款状态" prop="clssst">
                  <el-input v-model="basicForm.clssst_zn" :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="结清状态" prop="jqstus">
                  <el-input v-model="basicForm.jqstus_zn" :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="核销状态" prop="hxstus">
                  <el-input v-model="basicForm.hxstus_zn" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
  ...
  export default {
    ...
    methods: {
        ...
        infoGet(e) {
            ...
            this.sufinishTable = [];
            this.fsfyhxTable = [];
            this.basicForm.lncfno = e.target.value;
            if(this.basicForm.lncfno.length == 0){
                return false;
            }else{
                this.getSuitHisInfo();
            };
          ...
          MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
            .then(res => {
              if (res && res.code === "200" && res.data) {
                ...
                this.basicForm.nowvamt = this.nowvamt;
        ...
        getSuitHisInfo() {
          ...
          MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
            .then(res => {
              if (res && res.code === "200" && res.data) {
                  this.nowvamt = res.data.nowvamt; //当前委案金额
