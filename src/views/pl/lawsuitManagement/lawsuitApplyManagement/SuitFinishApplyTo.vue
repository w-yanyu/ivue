    ...
    <el-collapse v-model="activeNames" class="custom-common--collapse">
      ...
      <el-collapse-item name="3" >
        <template slot="title">
          ...
          <div class="warn-class">提示：该申请单提交结案后，将无法进行任何借款缴费！</div>
        </template>
        <el-form
          ref="applyForm"
          :rules="rules"
          ...
          <div class="border-Line">
            ...
            <el-row class="caSeq-table">
              <el-table :data="tableData">
                ...
                ></el-table-column>
                <el-table-column label="费用金额" align="center" prop="pay_amount"></el-table-column>
                <el-table-column label="收款账户名称" align="center" prop="rece_accno"></el-table-column>
                <el-table-column
                  label="缴费确认状态"
                  align="center"
                ...
                ></el-table-column>
                <el-table-column label="客户承担金额" align="center" prop="cust_amt"></el-table-column>
                <el-table-column label="法院退回金额" align="center" prop="court_back_amt"></el-table-column>
                <el-table-column label="已处理法院退回金额" align="center" prop="court_back_balance_after"></el-table-column>
                <el-table-column label="未处理法院退回金额" align="center" prop="court_back_balance"></el-table-column>
                <el-table-column label="公司承担金额" align="center" prop="compnay_amt"></el-table-column>
                <el-table-column label="已处理公司承担金额" align="center" prop="compnay_balance_after"></el-table-column>
                <el-table-column label="未处理公司承担金额" align="center" prop="compnay_balance"></el-table-column>
              </el-table>
            </el-row>
          </div>
          <el-row>
            <el-col :span="10" class="checkbx-label-style" v-show="false">
              <el-form-item prop="ispayover" label="该客户需偿还金额均已清偿完毕，现客户可结清">
                <el-checkbox-group v-model="applyForm.ispayover">
                  <el-checkbox label="确认" name="ispayover"></el-checkbox>
                </el-checkbox-group>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
      .then((res) => {
        if (res && res.code === "200") {
          ...
          this.applyForm.close_reason = res.data.close_reason;
