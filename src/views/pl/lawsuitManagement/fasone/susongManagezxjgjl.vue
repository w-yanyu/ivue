            ...
            <el-row>
              <el-col :span="12">
                <el-form-item
                  :label="$i18ns('执行文件类型')"
                  prop="exe_file_type"
                  :rules="[{ required: true, message: $i18ns('请选择执行文件类型') }]"
                >
                  <el-select
                    v-model="appForm.exe_file_type"
                    :placeholder="$i18ns('请选择执行文件类型')"
                  >
                    <el-option
              ...
              <el-col :span="12">
                <el-form-item
                  :label="$i18ns('执行结果案号')"
                  prop="exe_result_no"
                  :rules="[{ required: true, message: $i18ns('请输入执行结果案号')  }]"
                >
                  <el-input v-model="appForm.exe_result_no"   @change="implementNoChange"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item
                  :label="$i18ns('执行文件落款时间')"
                  prop="exe_file_tm"
                  :rules="[
                    { required: true, message: $i18ns('请选择执行文件落款时间') },
                  ]"
                >
                  <el-date-picker
