    ...
    <el-collapse v-model="activeNasmes" class="custom-common--collapse">
      ...
      <el-collapse-item name="third">
        ...
        <div class="container-centent--search">
          ...
          <el-col :span="8">
              <el-form-item label="用印原因"  prop="affix_reason" >
                <el-select v-model="applyForm.affix_reason" :disabled="true" placeholder>
                  <el-option
...
export default {
  ...
  created() {
    ...
    this.getDictList("E_WRIT_TYPE", "creditFileTypeList"); //承办机构字典类型
    ...
    MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
      .then((res) => {
        if (res && res.code === "200") {
         ...
         this.applyForm.attn_name = res.data.attn_name;
          this.applyForm.attn_phone = res.data.attn_phone;
          this.applyForm.attn_address = res.data.attn_address;
          this.applyForm.affix_reason = res.data.affix_reason;
