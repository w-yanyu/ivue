  ...
  <div>
    <el-collapse v-model="activeNasmes" class="custom-common--collapse">
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item :label="$i18ns('借据号')"  prop="loan_no"   :rules="[{ required: true, message: $i18ns('请输入借据号')}]">
                <el-input v-model="basicForm.loan_no" suffix-icon="el-input__icon el-icon-search" @click.native="openDialog"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
            ...
            <el-col :span="6">
              <el-form-item :label="$i18ns('核销历史')">
                <el-button    @click="queryReduHis" type="primary">{{$i18ns('核销历史')}}</el-button>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
      ...
      <el-collapse-item name="third">
        ...
        <el-form ref="adjustForm" :model="adjustForm" label-width="150px" class="custom-common--form">
          <el-row>
            <el-col :span="12">
              <el-form-item :label="$i18ns('核销本金')" :rules="[{ required: true, message: $i18ns('请输入核销本金')}]">
                <el-input v-model="adjustForm.write_off_princi"  oninput="value=value.replace(/[^0-9.]/g,'')" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$i18ns('核销利息')" :rules="[{ required: true, message: $i18ns('请输入核销利息')}]">
                <el-input v-model="adjustForm.write_off_inst" oninput="value=value.replace(/[^0-9.]/g,'')"  ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$i18ns('核销来源账号')" :rules="[{ required: false}]">
                <el-input v-model="adjustForm.write_off_src_acct_no"   oninput="value=value.replace(/[^0-9.]/g,'')"  ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$i18ns('核销来源账号子序号')" :rules="[{ required: false}]">
                <el-input v-model="adjustForm.write_off_src_acct_no_seq"   oninput="value=value.replace(/[^0-9.]/g,'')"  ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
    ...
    <div class="custom-common--footer">
      ...
      <el-dialog
        ...
        :append-to-body="true">
      <to-json to-url="/views/pl/writeoff/writeoff_history_list.json" :params="lncfnoObj"></to-json>
      </el-dialog>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      loanStatusList:[],
      ccyCodeList:[],
      busioprtflagList:[],  //  业务操作标志下拉
      writeoffinstflagList:[],  //  核销计息标志下拉
      yesornoList:[],  //  是否下拉
      remthdList: [], // 减免方式下拉
      remttpList: [], // 减免类型下拉
      adjrsnList: [], // 调整申请原因下拉
  ...
  created() {
    ...
    // this.getDictList("PL_E_CLSSST", "clssstList"); // 获取贷款状态下拉
     ...
     this.getDictList("MS_E_YESORNO", "yesornoList"); // 是否数据字典
  ...
  methods: {
    ...
    //  this.debtForm.recv_fee = "";
      this.adjustForm.write_off_princi = "";
      this.adjustForm.write_off_inst = "";
      this.adjustForm.write_off_src_acct_no = "";
      this.adjustForm.write_off_src_acct_no_seq = "";
      ...
      MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "POST", params)
        .then(response => {
          if (response && response.code === "200") {
            ...
            this.basicForm.contract_no = customerLoan.ctrct_num;
            this.adjustForm.loan_status   = customerLoan.loan_form;
    ...
    submit() {
      ...
      _this.adjustForm.loan_status=_this.adjustForm.loan_status;
      _this.adjustForm.contract_no=_this.basicForm.contract_no;
      _this.adjustForm.write_off_src_acct_no=_this.adjustForm.write_off_src_acct_no;
      _this.adjustForm.write_off_src_acct_no_seq=_this.adjustForm.write_off_src_acct_no_seq;
