    ...
    <div class="todo-top" v-if="show">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="240px" class="custom-common--form">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="申请状态" prop="asmt_ste" class="upload-item">
             <el-select
                v-model="Applys.asmt_ste"
                placeholder=""
                :disabled="true"
              >
                <el-option
...
export default {
      ...
      tabList: [
        {
          ...
          title: "资产转让明细",
          toRequest: {
            url: "/views/pl/assetAssignment/query/asset_transfer_info_view.json",
            method: "get",
            params: {
              "apply_no": this.cParentParams.apply_no,
              "asmt_code": this.cParentParams.asmt_code,
            },
          },
        },
        {
          ...
          title: "资产转让汇总",
          toRequest: {
            url: "/views/pl/assetAssignment/query/asset_total_info_view.json",
            method: "get",
            params: {
              "apply_no": this.cParentParams.apply_no,
              "asmt_code": this.cParentParams.asmt_code,
        ...
        },
        {
          ...
          title: "审批记录",
          toRequest: {
            url: "/views/pl/assetAssignment/query/approval_record.json",
            method: "get",
            params: {
              "apply_no": this.cParentParams.apply_no,
  ...
  created() {
    ...
    this.Applys.asmt_code = this.cParentParams.asmt_code;
    ...
    this.Applys.asmt_ste = "已处理";
    this.Applys.start_oprtr = "xadmin";
    this.Applys.actvn_org = "985000";
    this.Applys.actvn_org = "985000";


    this.Applys.busi_type = "资产转让";
    this.c_$params.asmt_code = this.cParentParams.asmt_code;
  ...
  setStatus(row, column) {
    return this.getSatus(row.asmt_ste);
  },
  getSatus(asmt_ste) {
      switch (asmt_ste) {
        case "3":
