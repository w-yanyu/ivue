  ...
  <div>
    <div class="todo-top" v-if="show">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="240px" class="custom-common--form">
        <el-row>
          <el-col :span="12">
            <el-form-item label="申请编号" prop="apply_no" class="upload-item">
              <el-input v-model="Applys.apply_no" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="产品类型" prop="hndov_prod_nm" class="upload-item">
              <el-input v-model="Applys.hndov_prod_nm" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="申请状态" prop="hndov_ste" class="upload-item" :formatter="setStatus">
              <el-select
                v-model="Applys.hndov_ste"
                placeholder=""
                :disabled="true"
              >
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="申请类型" prop="busi_type" class="upload-item">
              <el-select
                v-model="Applys.busi_type"
                placeholder=""
                :disabled="true"
              >
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="客户经理" prop="cur_agnt" class="upload-item">
              <el-input v-model="Applys.cur_agnt" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="申请机构" prop="actvn_org" class="upload-item">
              <el-input v-model="Applys.actvn_org" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="当前处理机构" prop="actvn_org" class="upload-item">
              <el-input v-model="Applys.actvn_org" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
      ...
      tabList: [
        {
          ...
          title: "查看",
          toRequest: {
            url: "/views/pl/assetHndov/handover/tranferCustApply_list_copy.json",
            method: "get",
            params: {
             // "apply_no": this.cParentParams.apply_no,
              "hndov_code": this.cParentParams.hndov_code 
            },
          },
        },
        {
          ...
          title: "审批记录",
          toRequest: {
            url: "/views/pl/assetHndov/query/approval_record.json",
            method: "get",
            params: {
              "apply_no": this.cParentParams.apply_no,
              "flow_no": this.cParentParams.flow_no
            },
          },
        }
  ...
  created() {
    this.Applys.hndov_prod_nm = this.cParentParams.hndov_prod_nm;
    this.Applys.hndov_code = this.cParentParams.hndov_code;
    this.Applys.start_oprtr = this.cParentParams.start_oprtr;
    this.Applys.hndov_ste = "已处理";
    this.Applys.busi_type = "资产移交";
    this.Applys.cur_agnt = this.cParentParams.cur_agnt;
    this.Applys.actvn_org = this.cParentParams.actvn_org;
    this.Applys.apply_no = this.cParentParams.apply_no;
   // this.Applys.applid = this.cParentParams.appl_id;


    this.c_$params.hndov_code = this.cParentParams.hndov_code;
