    ...
    <div class="todo-top" v-if="show">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="240px" class="custom-common--form">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item :label="$i18ns('申请状态')" prop="change_ste" class="upload-item" :formatter="setStatus">
              <el-select
          ...
          <el-col :span="12">
            <el-form-item :label="$i18ns('申请类型')" prop="adp_status" class="upload-item" >
              <el-select
...
export default {
  ...
  data() {
    return {
      ...
      tabList: [
        {
          idField: "tag1",
          title: this.$i18ns('客户信息'),
          toRequest: {
            url: "/views/us/privateManage/privateManage_info.json",
            method: "get",
            params: {
        ...
        {
          idField: "tag2",
          title: this.$i18ns('授信通知书'),
          toRequest: {
            url: "/views/pl/checkAfterLoan/informationList/letterOfCredit.json",
            method: "get",
            params: {
                  "cust_no":"${{params.cust_no}}"
            },
        ...
        {
          idField: "tag3",
          title: this.$i18ns('评级结果查看'),
          toRequest: {
            url: "/views/pl/checkAfterLoan/informationList/lookGradeResultTo.json",
            method: "get",
            params: {
                  "cust_no": "${{params.cust_no}}"
            },
        ...
        {
          idField: "tag5",
          title: this.$i18ns('授信及使用信息'),
          toRequest: {
            url: "/views/pl/checkAfterLoan/informationList/creditandUseInfoTO.json",
            method: "get",
            params: {
  ...
  created() {
    ...
    this.c_$params.cust_no = this.cParentParams.cust_no; // appid参数传递
        ...
        this.c_$params.reserve1 = this.cParentParams.loan_no; // appid参数传递
