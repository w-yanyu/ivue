...
export default {
      ...
      tabList: [
        {
          ...
          title: "客户信息",
          toRequest: {
            url: "/views/us/entManager/ent_cust_tree.json",
            method: "get",
            params: {
        ...
        },
        {
          ...
          title: "客户财务情况",
          toRequest: {
            url: "@corporateCustomerFinancialStatements",
            method: "get",
            params: {
               "cust_no": "${{params.cust_no}}"
            },
        ...
        },
        {
          ...
          title: "授信及使用信息",
          toRequest: {
            url: "/views/pl/checkAfterLoan/informationList/creditandUseInfoPublicTO.json",
            method: "get",
            params: {
  ...
  created() {
    ...
    this.c_$params.flow_no = this.cParentParams.flow_no; // appid参数传递     res.data.applys.procinstid
        this.c_$params.loan_no = this.cParentParams.loan_no; // appid参数传递
