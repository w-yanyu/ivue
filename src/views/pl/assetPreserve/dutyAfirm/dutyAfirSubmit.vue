      ...
      <el-collapse v-model="activeNames">
        ...
        <el-collapse-item name="3">
          ...
          <div style="padding:16px;">
            <el-button type="primary"  @click="addPayApply()" v-show="false">{{$i18ns('新增')}}</el-button>
          </div>
          ...
          <!-- <el-table-column label="操作" v-show="false" >
              <template slot-scope="scope" >
                 点击编辑进入编辑页面进行编辑表格数据
                <el-button size="small" type="danger" :disabled="true" @click="handleDelete(scope.$index, scope.row)">{{$i18ns('删除')}}</el-button>
              </template>
            </el-table-column>-->
          </el-table>
          <div class="space"></div>
          ...
          >
            <el-form-item :label="$i18ns('责任认定通知书')" width="200px" >
              ...
              <el-upload
                ...
                :auto-upload="false">
                <el-button size="small" v-show="false" type="primary">{{$i18ns('点击上传')}}</el-button>
              </el-upload>
            </el-form-item>
...
export default {
  ...
  created() {
    ...
    this.getDictList("PL_E_CLSSST","clssstList");//贷款状态
     this.params.apply_no=this.cParentParams.apply_no;
      this.getDutyInfo();
  },
