    ...
    <el-collapse v-model="activeNasmes" class="custom-common--collapse">
      ...
      <el-collapse-item name="third">
        ...
        <el-form ref="adjustForm" :model="adjustForm" label-width="150px" class="custom-common--form">
          <el-row>
            <el-col :span="12">
              <el-form-item :label="$i18ns('减免本金')">
                <el-input v-model="adjustForm.dert_amt"   oninput="value=value.replace(/[^0-9.]/g,'')" :disabled="true" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$i18ns('减免利息')">
                <el-input v-model="adjustForm.dert_inst"   oninput="value=value.replace(/[^0-9.]/g,'')"  :disabled="true" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$i18ns('调整申请原因')" prop="aply_adjust_reason">
                <el-select v-model="adjustForm.aply_adjust_reason" placeholder=" " :disabled="true">
                  <el-option
      ...
      this.$http.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
        .then(res => {
          if (res && res.code === "200" && res.data) {
            ...
            this.adjustForm.aply_adjust_reason = customerLoan.aply_adjust_reason;
            this.adjustForm.dert_inst = customerLoan.dert_inst;
            this.adjustForm.dert_amt = customerLoan.dert_amt;
