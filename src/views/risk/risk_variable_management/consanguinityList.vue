 ...
 * @LastEditTime: 2024-03-12 14:31:00
  ...
  <div class="container-content">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="变量代码" prop="variable_code">
              <el-select
                v-model="ruleForm.variable_code"
                placeholder="请选择变量代码"
                clearable
              >
                <el-option
    ...
    <div class="container-centent--table">
      ...
      >
        ...
        <el-table-column label="调用类型" width="200">
        ...
        <el-table-column label="调用状态" width="200">
          <template slot-scope="scope">
            <span>
              <font>
                <!-- {{ scope.row.called_status }} -->
                {{formatDictData(scope.row.call_status,callStatusList)}}
              </font>
            </span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="最近更新人" width="200">
          <template slot-scope="scope">
            <span>
              <font>
                {{ scope.row.called_object_name }}
...
export default {
  name: "VariableConsanguinityList",
  components: {
    comEchart
  },
  props: {
  ...
  created() {
    ...
    this.getDictList("DECI_E_CALL_STATUS", "callStatusList");
    this.searchTeller();
  ...
  methods: {
    ...
    searchTeller() {
      let reqMap = {
        variable_code: this.ruleForm.variable_code,
        ...
        // variable_code: "3",
        // called_object_type: "VARIABLES",
        // called_object_code: "变量名称A",
        // called_object_name: "变量A中文名",
    ...
    handleLook(row) {
      this.$dialog.open({
        ...
        toRequest: {
          url:
            "/views/risk/risk_variable_management/consanguinity_view.json",
          method: "get",
          params: { ...row }
        },
        width: "50%",
