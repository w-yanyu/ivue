<template>
    <div class="page_content">
        ...
        <el-table :data="group.ruleResultList " style="width: 100%" class="table">
            ...
            <el-table-column fixed="right" label="动作列表" width="100">
                <template slot-scope="scope">
                    <el-button
                        ...
                        type="text"
                        size="small"
                        v-if="scope.row.riskDecisionActionList"
                    >查看</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    mounted() {
        ...
        console.log("-点进了group---------",this.group.ruleResultList)
    ...
    formatHitFlag(row, column) {
        ...
        handleClick(row) {
            ...
            this.$dialog.open({
                ...
                title: "动作规则列表",
                toRequest: {
                    url: "@riskDecisionRuleGroupTestResultActionList1",
                    method: "get",
                    params: {
