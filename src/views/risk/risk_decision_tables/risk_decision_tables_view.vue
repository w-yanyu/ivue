        ...
        <el-form ref="form" :model="form" label-width="100px">
            <el-tabs type="border-card">
                <el-tab-pane>
                    ...
                    <to-json :toUrl="viewUrl " :params="cParentParams"></to-json>
                </el-tab-pane>

                <el-tab-pane>
                    <span slot="label">
                        <i class="el-icon-date"></i> 配置信息
                    </span>
                    <!-- G6 决策树渲染块
                    <DecisionTreeView
                        ref="decisionTree"
...
export default {
    ...
    data() {
        return {
            viewUrl: "/views/risk/risk_decision_tables/risk_decision_tables_view.json",
    ...
    created() {
        ...
        this.treeTitle = `${this.cParentParams.decision_tables_name}-${this.cParentParams.decision_tables_name}`;
    },
    methods: {
        //请求规则树数据
        requestTreeData() {
            ...
            // 集合
            let params = {
                treeId: that.cParams.treeId,
                servicecode: "deci040110",
                isList: true,
            };
            //获取规则树
            that.$http
