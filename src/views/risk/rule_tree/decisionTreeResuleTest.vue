  ...
  <div class="page_content">
    <!-- 规则树交易查询 -->
           <el-form :model="form" :rules="rules" ref="form" span="24" label-position="right">
            <el-row>
                <el-col span="12">
                    <el-form-item label="规则树代码" prop="treeCode" required="true">
                        <el-input
                            class="input_el_70"
                            placeholder="请点击按钮选择"
                            disabled
                ...
                <el-col span="12">
                    <el-form-item label="规则树名称" prop="treeName">
                        <el-input
                            class="input_el_70"
                            disabled
  ...
  export default {
    ...
    mounted() {
      console.log("父类传过来的参数", this.cParentParams);
       ...
       console.log("父类1传过来的参数", this.responseData);
      this.form.treeCode =  this.cParentParams.treeout.treeCode
      this.form.treeName =  this.cParentParams.treeout.treeName
      this.initTreeData();
    },
    computed: {
      // 规则描述
    ...
    methods: {
      ...
      initTreeData() {
        let that = this;
        that.treeData = that.cParentParams.treeout;
