<template>
    <div class="page_content">
        <el-form :model="form" :rules="rules" ref="form" span="24" label-position="right">
            <el-row>
                <el-col span="12">
                    <el-form-item label="规则树代码" prop="treeCodes" required="true">
                        <el-input
                            class="input_el_70"
                            placeholder="请点击按钮选择"
                            disabled
                            v-model="form.treeCodes"
                            type="text"
                        ></el-input>
                ...
                <el-col span="12">
                    <el-form-item label="规则树名称" prop="treeName"  required="true">
                        <el-input class="input_el_70" disabled v-model="form.treeName" type="text"></el-input>
                    </el-form-item>
                </el-col>
                <el-col span="12">
     ...
     */
        ...
        openDialog() {
            ...
            that.$dialog.open({
                ...
                title: "规则树代码选择",
                toRequest: {
                    url: "/views/risk/rule_tree/risk_rule_tree_lookup.json",
                    method: "get",
                },
                width: "70%",
            });
        ...
        jsonCallBack(btnConfig, response) {
            ...
            this.form.treeCodes = `${response.treeCode}`;
            this.form.treeName = `${response.treeName}`;
