...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      initTreeData() {
        let that = this;
        that.ruleForms.treeCode = that.cParentParams.treeCode
        that.ruleForms.treeName = that.cParentParams.treeName
        that.treeData = that.cParentParams;
