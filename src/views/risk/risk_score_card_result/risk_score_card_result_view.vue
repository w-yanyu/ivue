<template>
  <div class="page_content">
    ...
    >
      <el-row>
        <el-col :span="6">
          <el-form-item label="流水号 " prop="trxnSeq" label-width="100px" v-if="false">
            <el-input
              class="input_el"
              v-model="ruleForm.trxnSeq"
              disabled
            ></el-input>
          </el-form-item>
        </el-col>
    ...
    >
      ...
      <el-table-column prop="inputValue" label="输入值"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    //   let responseData1 = result.nothit;
    //    if (responseData1!==undefined) {
    //   responseData1.forEach((item, index) => {
