    ...
    <div class="page_content">
        <el-form class="table_content" ref="ruleForm" :model="ruleForm" :rules="rules">
            ...
            <el-row>
                ...
                <el-col span="8">
                    <el-form-item label="最新维护时间" prop="applyTime" label-width="120px">
                        <el-input class="input_el" v-model="ruleForm.applyTime" disabled @blur="Input($event)"></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
...
export default {
    ...
    methods: {
        init() {
            ...
            this.ruleForm.applyTime = this.cParams.applyTime; //时间
