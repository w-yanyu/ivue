                ...
                <el-tab-pane>
                    ...
                    <el-form class="table_content">
                        ...
                        >
                            ...
                            <el-table-column prop="scorAttributePercent" label="权重">
                                <template slot-scope="scope">
...
export default {
    ...
    methods: {
        ...
        addTable() {
            ...
            let attributeDisabledFlag = false;
            this.showEditDialog("新增条件", attributeDisabledFlag);
        },
        //修改的弹出窗口
        ...
        //新增的弹出窗口
        showEditDialog(titleName, attributeDisabledFlag) {
            console.log("准备打开评分卡编辑窗口");
            let that = this;
            that.$dataBus.bindCallBackMethod(that, that.editDialogCallBack, {});
            that.$dialog.open({
                ...
                toRequest: {
                    ...
                    params: {
                        ...
                        attributeDisabledFlag: attributeDisabledFlag,
                    },
                },
                width: "85%",
            });
