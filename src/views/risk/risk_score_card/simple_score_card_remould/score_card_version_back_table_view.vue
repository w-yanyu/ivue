            ...
            <el-tabs type="border-card">
                <el-tab-pane>
                    ...
                    <el-form class="table_content" ref="ruleForm" :model="ruleForm" :rules="rules">
                        <el-row span="24">
                            <el-col span="8">
                                <el-form-item label="复杂评分卡代码 " prop="scoreCardCode" label-width="130px">
                                    <el-input v-model="ruleForm.scoreCardCode" disabled></el-input>
                                </el-form-item>
                            </el-col>

                            <el-col span="8">
                                <el-form-item label="复杂评分卡名称 " prop="scoreCardName" label-width="130px">
                            ...
                            <el-col span="8">
                                <el-form-item label="版本号 " prop="version" label-width="130px">
                        ...
                        <el-row span="24">
                            <el-col>
                                <el-form-item label="备注 " prop="description" label-width="130px">
