...
export default {
    ...
    methods: {
        ...
        versionFallback() {
            let that = this;
            if (this.selectVersion === undefined) return;
            let params = {
                scoreCardId: this.selectVersion.scoreCardId, //id
                scoreCardCode: this.selectVersion.scoreCardCode, //评分卡代码
                version: this.selectVersion.version, //版本号
