                        ...
                        <el-row span="24">
                            <el-col span="8">
                                <el-form-item label="服务对象 " prop="serviceObject" label-width="120px">
                                    <el-input v-model="ruleForm.serviceObject" disabled></el-input>
                                </el-form-item>
                            </el-col>

                            <el-col span="8">
                                <el-form-item label="最新维护人" prop="applyUser" label-width="120px">
                                ...
                                <!-- <el-form-item label="最新维护人 " prop="scoreCardName" label-width="120px">
                                    <el-input v-model="ruleForm.updateUser" maxlength="125" @blur="Input($event)"
                                        disabled></el-input>
                                </el-form-item> -->
                            </el-col>

                            <el-col span="8">
                                <el-form-item label="最新维护时间 " prop="version" label-width="120px">
                                    <el-input v-model="ruleForm.applyTime" maxlength="125" disabled></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <el-row>
                            <el-col span="8">
                                <el-form-item label="机构名称" prop="branchId" label-width="120px">
                                    <el-select v-model="ruleForm.branchId" placeholder="请选择" :disabled="true">
                            ...
                            <el-col>
                                <el-form-item label="备注 " prop="description" label-width="120px">
                                    <el-input class="input_el" v-model="ruleForm.description" @blur="Input($event)"
                                        type="textarea" maxlength="200" rows="5" show-word-limit disabled></el-input>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        <!-- <el-row span="24">
...
export default {
    ...
    methods: {
        ...
        init() {
            ...
            this.ruleForm.updateTime = this.cParams.updateTime; //更新时间
            this.ruleForm.applyTime = this.cParams.applyTime; //更新时间
            this.ruleForm.applyUser = this.cParams.applyUser;
            this.ruleForm.updateUser = this.cParams.updateUser; //更新人
            this.ruleForm.branchId = this.cParams.branchId; //机构号
            this.ruleForm.serviceObject = this.cParams.serviceObject; //服务对象
        },
        getUserList() {
            let params = {
                servicecode:"ct2503",
                newuser_id:this.cParams.applyUser
            };
            //请求表格数据
            this.$http
