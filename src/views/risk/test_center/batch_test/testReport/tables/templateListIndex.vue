<template>
    <div class="table_container">
        <div id="print">
            <h1>测试报告</h1>
            <div v-for="(item, index) in tableDataList" :key="index" class="margin-b-20">
                <to-json
...
export default {
    ...
    data() {
        return {
            ...
            tableDataList: [
                {
                    report_path: "@basicTemplate",
                    params: {}
                },
                {
                    report_path: "@executionLogTemplate",
                    params: {}
                },
                {
                    report_path: "@dataSourceTemplate",
                    params: {}
                },
                {
                    report_path: "@variableTemplate",
                    params: {}
                },
                {
                    report_path: "@testResultTemplate",
                    params: {}
                },
                {
                    report_path: "@resultDistributionTemplate",
                    params: {}
                }
            ], //各表数据以及对应字段信息
            sale_prod_cd: "", // 可售产品编号
