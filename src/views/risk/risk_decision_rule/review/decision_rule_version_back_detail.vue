            ...
            <el-tabs type="border-card">
                ...
                <el-tab-pane label="规则配置">
                    <rule-select style="overflow:auto;min-width: 900px;" :componentName="componentName" :action="actions"
                        ...
                        :setRuleValue="setRuleValue" :fun-detail-list="funDetailList" :disabled="true"></rule-select>
                    <div style="height: 20px;"></div>
                    <el-form-item label="规则描述" label-width="120px">
                        <el-input type="textarea" :disabled="true" :value="crtZhRule" spellcheck="false"></el-input>
                    </el-form-item>
                ...
                <el-tab-pane>
                    ...
                    <ActionConfigurationHistory ref="ActionConfigurationHistory" isDisable="true"
                        :cParentParams="cParentParams.cParentParams"></ActionConfigurationHistory>
                </el-tab-pane>
            </el-tabs>
        </el-form>
...
<script>
import ActionConfigurationHistory from "@/components/ActionConfigurationHistory.vue";
...
export default {
    ...
    created() {
        console.log(
            "decision_rule_version_back_table_view-------cParams",
            this.cParams
        );
