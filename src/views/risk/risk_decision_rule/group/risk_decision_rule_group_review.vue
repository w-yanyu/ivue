<template>
    <div class="page_content">
        <el-form :model="ruleForm" ref="ruleForm" label-width="120px" :rules="rules">
            <el-row :span="24">
                <el-col :span="6">
                    <el-form-item label="审核Id" prop="reviewId">
                        <el-input size="medium" disabled v-model="ruleForm.reviewId" />
                    </el-form-item>
                </el-col>
                <el-col :span="6">
                    <el-form-item label="规则组id" prop="groupId">
                        <el-input size="medium" disabled v-model="ruleForm.groupId" />
                    </el-form-item>
                </el-col>
                <el-col :span="6">
      ...
      <el-row class="menu-footer">
        <el-col :span="24">
          <el-button type="primary" size="small" @click="dialogVisible = true"
            >通过</el-button
          >
          <el-button type="warning" size="small" @click="dialogVisible1 = true"
            >退回</el-button
          >
        </el-col>
      </el-row>
...
export default {
    ...
    mounted() {
        ...
        that.ruleForm.ruleNameBefore = this.cParentParams.ruleNameBefore;
        that.ruleForm.ruleNameAfter = this.cParentParams.groupNameAfter;
        that.ruleForm.descriptionBefore = this.cParentParams.descriptionBefore;
        that.ruleForm.descriptionAfter = this.cParentParams.descriptionAfter;
        that.ruleForm.natureExpressionBefore = this.cParentParams.natureExpressionBefore;
        that.ruleForm.natureExpressionAfter = this.cParentParams.natureExpressionAfter;
        that.ruleForm.ruleDescBefore = this.cParentParams.ruleDescBefore;
        that.ruleForm.ruleDescAfter = this.cParentParams.ruleDescAfter;
        that.ruleForm.executableExpressionBefore = this.cParentParams.resourceAfter;
        that.ruleForm.executableExpressionAfter = this.cParentParams.resourceBefore;
    ...
    methods: {
        ...
        requestTableData() {
            ...
            let params = {
                ...
                rule_code: that.ruleForm.groupCode,
                servicecode:
                    "deci010514"
            };
            that.$http
