  ...
  <div class="page_content">
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="字典代码 " prop="dictCode" label-width="100px">
            <el-input v-model="ruleForm.dictCode" disabled></el-input>
          </el-form-item>
        </el-col>

        <el-col span="12">
          <el-form-item label="字典名称 " prop="dictName" label-width="100px">
            <el-input v-model="ruleForm.dictName" clearable disabled></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col span="12">
          <el-form-item label="数据类型 " prop="dataTypeShow" label-width="100px">
            <el-select style="width:100%" v-model="ruleForm.dataTypeShow" :label-in-value="true" clearable
              @change="dataTpyeChange" disabled>
        ...
        <el-col span="12">
          <el-form-item label="状态 " prop="status" label-width="100px">
            <el-radio-group v-model="ruleForm.status" @change="statusChange" disabled>
      ...
      <el-row>
        <el-col>
          <el-form-item label="枚举值 " prop="description" label-width="100px">
            <el-button type="primary" size="small" @click="addTable" disabled>新增
            </el-button>
          </el-form-item>
        </el-col>
      </el-row>
    ...
    <el-form class="table_content">
      ...
      <el-row class="menu-footer">
        <el-col :span="24">
          <el-button type="primary"  size="small" @click="clickCancel">返回</el-button>
        </el-col>
      </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      clickConfirm() {
        ...
        this.$http
          .invokeAPI("/API" + Api.risk_dict_update_list, "POST", this.riskDictValueList)
          .then(obj => {
            if (obj.code === "200") {
