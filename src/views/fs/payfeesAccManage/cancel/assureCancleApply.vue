      ...
      <el-collapse v-model="activeNames">
        ...
        <el-collapse-item name="2">
          ...
          <el-form ref="appForm" :rules="appRules" :model="appForm" label-width="250px" class="custom-common--form">
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="撤保原因:" prop="cancelReasion">
                  <el-select v-model="appForm.cancelReasion">
                    <el-option v-for="item in cancelReasionList" :key="item.dictId" :label="item.dictName"
                               :value="item.dictId"/>
                  </el-select>
                </el-form-item>
              </el-col>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.getDictList("E_CANCLE_RESION", "cancelReasionList"); // 撤保原因
      this.initAssureInfo();
      this.initRule();
    },
    ...
    methods: {
      initRule() {
        this.appRules = {
          cancelReasion: [{required: true, message: "请输入撤保原因"}],
          ...
          if (valid) {
            this.$confirm("是否确认提交申请?", "提示", {
              ...
              let params = {
                ...
                cancelReasion:this.appForm.cancelReasion,//撤保原因
