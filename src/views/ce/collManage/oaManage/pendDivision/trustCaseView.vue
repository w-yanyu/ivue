<template>
    <div>
       <el-table ref="multipleTable" :data="waitTrustApplyInfo.waitAllocateCountInfo" :border="true" style="margin: 30px !important;">
            ...
            <el-row>
                <el-col :span="24">
                    <el-form-item :label="$i18ns('备注:')"  prop="remark" >
                        <el-input type="textarea" :autosize="{minRows:2, maxRows: 5}" v-model="waitTrustApplyInfo.remark" disabled></el-input>
                    </el-form-item>
                </el-col>
            </el-row>
        </el-form>
