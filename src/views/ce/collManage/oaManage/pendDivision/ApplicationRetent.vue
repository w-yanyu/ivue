      ...
      <el-collapse v-model="activeNames">
        <el-collapse-item name="5">
          ...
          <el-form ref="appForm" :rules="appRules" :model="appForm" label-width="200px" class="custom-common--form">
            <el-row>
               <el-col :span="7">
                            <el-form-item label="留案类型" prop="fileType">
                                <el-select v-model="appForm.fileType" placeholder="请选择分案类型">
                                    <el-option
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="留案清单" prop="laqd">
                  <application-retent-upload ref="laqdProp" :uploadFileList="appForm.laqd" :uploadDisabled="false"  @changeFile="laqdChange"></application-retent-upload>
                </el-form-item>
              </el-col>
              <el-col :span="6">
