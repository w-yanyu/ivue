            ...
            <el-row>
              <el-col :span="8">
                <el-form-item class="require-asterisk" label="留案清单" prop="laqd">
                  <upload-file ref="laqdProp" :uploadFileList="appForm.laqd" :uploadDisabled="true" :limit="1" @changeFile="laqdChange" :key="timer"></upload-file>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-button size="small" type="primary" @click="download" :uploadDisabled="true">模板导出</el-button>
              </el-col>
              <el-col :span="10">
