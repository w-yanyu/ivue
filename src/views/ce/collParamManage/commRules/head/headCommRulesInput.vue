        ...
        <div class="container-content">
          ...
          <div class="container-centent--table">
            <el-table ref="modifyTable" :data="tableData" :border="true" stripe >
              ...
              <el-table-column label="费率%" prop="comm_rate" width="130" align="center">
                <template slot-scope="scope">
    ...
    methods: {
      ...
      queryHeadStrategy(){
        let params2 = {
          ...
          servicecode: "RLMSPLTS1209_pl1209",
        }
      ...
      requestRlms(){
        let params2 = {
          servicecode: "RLMSPLTS1202_pl1202",
          headCommRulesList: this.tableData,
          applid: this.cParentParams.applid,
        }
        MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params2).then(response => {
          if (response && response.code === "200" ) {
