    ...
    <div>
      <el-collapse v-model="activeNames">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item  label="变更后外包机构名称" prop="oa_org_name" >
          ...
          <el-col :span="12">
            <el-form-item  label="变更后统一社会信用代码" prop="social_credit_code" >
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="变更后注册资本" prop="regis_capital" >
          ...
          <el-col :span="12">
            <el-form-item  label="变更后办公地址" prop="addr" >
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item  label="变更后经营状态" prop="operation_status" >
          ...
          <el-col :span="12">
            <el-form-item  label="变更后经营范围" prop="operation_scope" >
          ...
          <el-col :span="12">
            <el-form-item  label="变更后法人代表" prop="ceo" >
          ...
          <el-col :span="12">
            <el-form-item  label="变更后股东信息" prop="stockholder" >
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="变更后营业执照" prop="bgyyzz" >
              <upload-file ref="bgyyzzProp" :uploadFileList="appForm.bgyyzz" :uploadDisabled="false" @changeFile="bgyyzzChange"></upload-file>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="变更通知书" prop="bgtzs" >
...
      },
      ...
      bgyyzzValidate(value, rule, callback) {if (this.appForm.bgyyzz.length === 0) {  return callback(new Error("请上传变更后营业执照"));   }return callback();   },
      bgtzsValidate(value, rule, callback) {if (this.appForm.bgtzs.length === 0) {  return callback(new Error("请上传变更通知书"));   }return callback();   },
    }
  }
