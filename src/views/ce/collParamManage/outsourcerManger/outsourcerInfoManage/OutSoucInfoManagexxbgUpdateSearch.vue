            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item
                  ...
                  v-show="isShow"
                >
                  <el-input v-model="appForm.oa_org_name"   :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item
              ...
              <el-col :span="12">
                <el-form-item
                  ...
                  v-show="isShow"
                >
                  <el-input v-model="appForm.social_credit_code"  :disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item
                  ...
                  v-show="isShow"
                >
                  <el-input v-model="appForm.regis_capital"  :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="办公地址" prop="addr">
              ...
              <el-col :span="12">
                <el-form-item
                  ...
                  v-show="isShow"
                >
                  <el-input v-model="appForm.addr"  :disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item
                  ...
                  v-show="isShow"
                >
                  <el-input v-model="appForm.operation_status"  :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="经营范围" prop="operation_scope">
              ...
              <el-col :span="12">
                <el-form-item
                  ...
                  v-show="isShow"
                >
                  <el-input v-model="appForm.operation_scope"  :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="法人代表" prop="ceo">
              ...
              <el-col :span="12">
                <el-form-item
                  ...
                  v-show="isShow"
                >
                  <el-input v-model="appForm.ceo"  :disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item
                  ...
                  v-show="isShow"
                >
                  <el-input v-model="appForm.stockholder"  :disabled="true"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
...
export default {
  name: "OutSoucInfoManagexxbgUpdateSearch",
  components: {
    UploadFile,
    ChangeHisList,
  },
