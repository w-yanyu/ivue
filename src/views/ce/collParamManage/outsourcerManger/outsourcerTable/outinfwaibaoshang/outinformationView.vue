        ...
        <el-collapse-item name="5">
          ...
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="考核结果:" prop="isWork">
              ...
              <el-row>
                <el-col :span="12">
                <el-form-item class="require-asterisk" label="考核报告" prop="khbg" v-show="isShow">
                  <upload-file ref="khbgProp" :uploadFileList="appForm.khbg" :uploadDisabled="true" @changeFile="khbgChange" :key="timer"></upload-file>
                </el-form-item>
              </el-col>
             </el-row>
             <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="退出评审单" prop="fileLists" v-show="!isShow">
                  <upload-file ref="fileListsProp" :uploadFileList="appForm.fileLists" :uploadDisabled="true" @changeFile="fileListsChange" :key="timer"></upload-file>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
          <el-col :span="12">
            <el-form-item :class="{'require-sign': !isShow}" :label="$i18ns('备注:')" prop="remakes">
              <el-input type="textarea" v-model="appForm.remakes" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
          </el-form>
