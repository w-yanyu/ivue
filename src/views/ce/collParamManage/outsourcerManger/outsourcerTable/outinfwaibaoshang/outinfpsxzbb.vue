...
<div>
    <div class="container-content">
        <div class="container-content--search">
            <el-button type="primary" @click="modifyStrategy()" plain>人员维护</el-button>
        </div>
        <div class="container-centent--table">
            <el-table ref="multipleTable" :data="tableData" :border="true" style="width: 100%" stripe>
                ...
                <el-table-column label="姓名" prop="user_name" width="500" align="center" show-overflow-tooltip></el-table-column>
            </el-table>
        </div>
    </div>
    <el-dialog title="人员维护" :visible.sync="strategyModelVisible" :show-close="true" :before-close="handleClosess" width="1200px" :close-on-click-modal="false" :append-to-body="true">
            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item class="require-asterisk" label="新增人员证明文件" prop="psxzba">
                        <upload-file ref="psxzbaProp" :uploadFileList="appForm.psxzba" :uploadDisabled="false" @changeFile="psxzbaChange"></upload-file>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row>
            ...
            MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params2).then(response => {
                if (response && response.code === "200" ) {
                    response.data.review.forEach(item=>{
                        ...
                        strategy.branch_name = item.branch_name;
                        strategy.post = item.post;
                        strategy.user_id = item.user_id;
                        strategy.user_name = item.user_name;
