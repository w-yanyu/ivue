  ...
  <div>
    <div>
      <el-collapse v-model="activeNames">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item ref="acctNo"  class="require-asterisk" label="收款账户账号" prop="acctNo" v-show="isShow">
              <el-input v-model="appForm.acctNo"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item ref="bankNo" class="require-asterisk" label="开户行号" prop="bankNo" v-show="isShow">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="营业执照" prop="yyzz" v-show="isShow">
              <upload-file ref="yyzzProp" :uploadFileList="appForm.yyzz" :uploadDisabled="false" @changeFile="yyzzChange"></upload-file>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="法人身份证" prop="frsfz" v-show="isShow">
              <upload-file ref="frsfzProp" :uploadFileList="appForm.frsfz" :uploadDisabled="false" @changeFile="frsfzChange"></upload-file>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="工商信息验证" prop="gsxxyz" v-show="isShow">
              <upload-file ref="gsxxyzProp" :uploadFileList="appForm.gsxxyz" :uploadDisabled="false" @changeFile="gsxxyzChange"></upload-file>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="涉诉验证" prop="ssyz" v-show="isShow">
              <upload-file ref="ssyzProp" :uploadFileList="appForm.ssyz" :uploadDisabled="false" @changeFile="ssyzChange"></upload-file>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
<!--              <upload-file ref="fxscsqbgProp" :uploadFileList="appForm.fxscsqbg" :uploadDisabled="false" @changeFile="fxscsqbgChange"></upload-file>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="为我司服务人员信息" prop="fwry" v-show="isShow">
              <upload-file ref="fwryProp" :uploadFileList="appForm.fwry" :uploadDisabled="false" @changeFile="fwryChange"></upload-file>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="为我司服务人员社保证明" prop="sbzm" v-show="isShow">
              <upload-file ref="sbzmProp" :uploadFileList="appForm.sbzm" :uploadDisabled="false" @changeFile="sbzmChange"></upload-file>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="租赁合同或办公场地照片" prop="zlht" v-show="isShow">
              <upload-file ref="zlhtProp" :uploadFileList="appForm.zlht" :uploadDisabled="false" @changeFile="zlhtChange"></upload-file>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="合作机构协议" prop="hzjgxy" v-show="isShow">
              <upload-file ref="hzjgxyProp" :uploadFileList="appForm.hzjgxy" :uploadDisabled="false" @changeFile="hzjgxyChange"></upload-file>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="保证金确认函" prop="bzjqrh" v-show="isShow">
              <upload-file ref="bzjqrhProp" :uploadFileList="appForm.bzjqrh" :uploadDisabled="false" @changeFile="bzjqrhChange"></upload-file>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="廉洁合作承诺书" prop="ljhzcns" v-show="isShow">
              <upload-file ref="ljhzcnsProp" :uploadFileList="appForm.ljhzcns" :uploadDisabled="false" @changeFile="ljhzcnsChange"></upload-file>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="合规催收承诺函" prop="hgcscnh" v-show="isShow">
              <upload-file ref="hgcscnhProp" :uploadFileList="appForm.hgcscnh" :uploadDisabled="false" @changeFile="hgcscnhChange"></upload-file>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item class="require-asterisk" label="催记承诺函" prop="cjcnh" v-show="isShow">
              <upload-file ref="cjcnhProp" :uploadFileList="appForm.cjcnh" :uploadDisabled="false" @changeFile="cjcnhChange"></upload-file>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label="其他协议" prop="qtxy" v-show="isShow">
              <upload-file ref="qtxyProp" :uploadFileList="appForm.qtxy" :uploadDisabled="false" @changeFile="qtxyChange"></upload-file>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
          .then(res => {
            if (res && res.code === "200" && res.data) {
              ...
              this.appForm.acctNo=this.basicForm.acct_no;
              this.appForm.acctName=this.basicForm.acct_name;
              this.appForm.bankNo=this.basicForm.bank_no;
              this.appForm.bankName=this.basicForm.bank_name;
              this.appForm.startDate=this.basicForm.work_begin_time;
              this.appForm.endDate=this.basicForm.work_end_time;
        ...
        return (rule, value ,callback) =>{
          if(!value){
            ...
            if(!reg16.test(value) && !reg19.test(value)){
              return callback(new Error("请输入16位或19位收款账户账号"));
            }else{
              this.$refs.acctNo.clearValidate();
              return callback();
            }
          }
        }
