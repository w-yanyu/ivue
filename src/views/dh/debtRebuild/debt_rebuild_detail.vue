    ...
    <el-collapse v-model="activeNasmes" class="custom-common--collapse">
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item :label="$i18ns('合同编号')">
                <el-input v-model="basicForm.ctrct_num" :disabled="true"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
      ...
      <el-collapse-item name="second">
        ...
        <el-form ref="adjustForm" :model="adjustForm" label-width="120px" class="custom-common--form">
          <el-row>
            <el-col :span="6">
              <el-form-item :label="$i18ns('贷款余额')">
                <el-input v-model="adjustForm.loan_balance"  :disabled="true"></el-input>
              </el-form-item>
            </el-col>

            <el-col :span="6">
              <el-form-item :label="$i18ns('逾期金额')">
                <el-input v-model="adjustForm.ovdue_amt" :disabled="true"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item :label="$i18ns('贷款利率')">
                <el-input v-model="adjustForm.bchmk_int_rate"  :disabled="true"></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="6">
              <el-form-item :label="$i18ns('逾期本金')">
                <el-input v-model="adjustForm.overdue_princi" :disabled="true"/>
              </el-form-item>

            </el-col>
            <el-col :span="6">
              <el-form-item :label="$i18ns('呆滞本金')" >
                <el-input v-model="adjustForm.stgnt_prcpl_occr_amt" :disabled="true"/>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item :label="$i18ns('核销本金')">
                <el-input v-model="adjustForm.write_off_princi" :disabled="true"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item  label="是否减免" >
                                <el-select v-model="adjustForm.is_dert" :disabled="true">
                                    <el-option v-for="(item, i) in yesnoList" :key="i" :label="item.dictName"
                                        :value="item.dictId"></el-option>
                                </el-select>
                            </el-form-item>
             <!-- <el-form-item :label="$i18ns('是否减免')">
                <el-input v-model="adjustForm.is_dert"  :disabled="true"></el-input>
              </el-form-item>-->
            </el-col>
            <el-col :span="6">
              <el-form-item :label="$i18ns('减免金额')">
                <el-input v-model="adjustForm.dert_smtn"  :disabled="true"></el-input>
              </el-form-item>
            </el-col>
      ...
      <el-collapse-item name="third">
        ...
        <template slot="title">
          <span><em></em>{{$i18ns('重组信息')}}</span>
        </template>
        <el-form ref="adjustForm" :model="adjustForm" label-width="150px" class="custom-common--form">
          <el-row>
            <el-col :span="12">
              <el-form-item :label="$i18ns('重组金额')" >
                <el-input v-model="adjustForm.rebuild_amt"   oninput="value=value.replace(/[^0-9.]/g,'')" :disabled="true" ></el-input>
              </el-form-item>
            </el-col>      
            <el-col :span="12">
              <el-form-item :label="$i18ns('重组利率')" >
                <el-input v-model="adjustForm.aprvl_int_rate"   oninput="value=value.replace(/[^0-9.]/g,'')" :disabled="true" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$i18ns('重组期数')">
                <el-input v-model="adjustForm.installment_num"   oninput="value=value.replace(/[^0-9.]/g,'')" :disabled="true" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item :label="$i18ns('重组方式')" prop="debt_recmbn_way" >
                <el-select v-model="adjustForm.debt_recmbn_way" placeholder=" " :disabled="true">
                  <el-option
...
export default {
  ...
  computed: {
    debtTotal() {
      let total = this.sumCalc(this.adjustForm.dert_inst, this.adjustForm.dert_penalt_inst, this.adjustForm.derate_overdue_fine);
      return total;
    }
  },
  created() {
      ...
      this.$http.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
        .then(res => {
          if (res && res.code === "200" && res.data) {
            ...
            // 基础信息填充
            this.basicForm.ctrct_num = customerLoan.ctrct_num;
            ...
            this.basicForm.prod_no = customerLoan.prod_no;
            // 余额信息填充
            ...
            this.adjustForm.bchmk_int_rate=customerLoan.bchmk_int_rate;
            this.adjustForm.write_off_princi=customerLoan.write_off_princi;
            this.adjustForm.dert_smtn=customerLoan.dert_smtn;
            this.adjustForm.loan_balance=customerLoan.loan_balance;
            this.adjustForm.aprvl_int_rate=customerLoan.aprvl_int_rate;
            this.adjustForm.ovdue_amt=customerLoan.ovdue_amt;
            this.adjustForm.normal_princi = customerLoan.normal_princi;
            this.adjustForm.overdue_princi = customerLoan.overdue_princi;
            this.adjustForm.stgnt_prcpl_occr_amt = customerLoan.stgnt_prcpl_occr_amt;
            this.adjustForm.uncollect_acct_princi = customerLoan.uncollect_acct_princi;
            this.adjustForm.debt_recmbn_way=customerLoan.debt_recmbn_way;
            this.adjustForm.remark = customerLoan.remark;
            this.adjustForm.rebuild_amt=customerLoan.rebuild_amt;
            this.adjustForm.installment_num=customerLoan.installment_num;
            this.adjustForm.is_dert=customerLoan.is_dert;
          }
        })
    },
    /**
