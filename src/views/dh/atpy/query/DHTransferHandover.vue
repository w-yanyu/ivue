    ...
    <div class="todo-top" v-if="show">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="240px" class="custom-common--form">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="产品类型" prop="simwf_name" class="upload-item">
              <el-input v-model="Applys.simwf_name" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="申请状态" prop="trans_status" class="upload-item" :formatter="setStatus">
              <el-select
                v-model="Applys.trans_status"
                placeholder=""
                :disabled="true"
              >
                <el-option
          ...
          <el-col :span="12">
            <el-form-item label="申请类型" prop="atp_status" class="upload-item">
              <el-select
...
export default {
      ...
      tabList: [
        {
          ...
          title: "查看",
          toRequest: {
            url: "/views/dh/transfer/handover/tranferCustApply_list_copy.json",
            method: "get",
            params: {
  ...
  created() {
    this.Applys.simwf_name = this.cParentParams.simwf_name;
    this.Applys.transfer_id = this.cParentParams.transfer_id;
    this.Applys.start_usr = this.cParentParams.start_usr;
    this.Applys.trans_status = "已处理";
    this.Applys.atp_status = "资产移交";
    ...
    this.c_$params.transfer_id = this.cParentParams.transfer_id;
