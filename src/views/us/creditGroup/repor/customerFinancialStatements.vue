...
export default {
  name: "customerFinancialStatements",
  props: {
  ...
  data() {
    return {
      ...
      //资产负债
      assetsLliabilitiesUrl: "/views/us/financialManager/custReportDataManager/assetsLliabilities_list.json",
      // 收入支出
      incomeFlowUrl: "/views/us/financialManager/custReportDataManager/incomeAndEx_list.json",
    ...
    handleClick(tab, event) {
      ...
      switch (tab.name) {
        ...
        case 'cashFlowStatement':
          ...
          break;
        case 'incomeAndExStatement':
          // that.$refs.cashFlowStatement.setStatementType('cashFlowStatement');
          that.$refs.incomeAndExStatement.initTableData('04')
          break;
      }
    }
