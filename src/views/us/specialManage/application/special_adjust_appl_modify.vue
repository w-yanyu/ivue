<template>
  <div>
    <el-form ref="ruleForm" :model="Applys" :rules="rules" class="custom-common--form" label-width="190px">
      <el-row>
        <el-col :span="8">
          <el-form-item class="upload-item" label="调整申请号" prop="appl_no" required="true">
            <el-input v-model="Applys.appl_no" disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="upload-item" :label="$i18ns('申请人')" prop="appt" required="true">
            <el-input v-model="Applys.appt" disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="upload-item" :label="$i18ns('申请时间')" prop="appl_time" required="true">
            <el-input v-model="Applys.appl_time" disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="upload-item" label="调整状态" prop="adjust_status" required="true">
        ...
        <el-col :span="8">
          <el-form-item class="upload-item" label="客户编号" prop="cust_no" required="true">
            <el-input v-model="Applys.cust_no" disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="upload-item" label="客户名称" prop="cust_name" required="true">
            <el-input v-model="Applys.cust_name" disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="upload-item" label="调整类型" prop="adj_type" required="true">
        ...
        <el-col :span="8">
          <el-form-item class="upload-item" label="组合编号" prop="temp_no" required="true">
            <el-input v-model="Applys.temp_no" disabled="true"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item class="upload-item" label="组合名称" prop="temp_name" required="true">
      ...
      <el-row class="custom-common--footer">
        <el-button :disabled="submitLoading" size="small" type="primary" @click="mainModifySubmit">{{$i18ns('保存')}}</el-button>
      </el-row>
    </el-form>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    changeComponentHandle(changeValue) {
      ...
      if (changeValue.enum_type !== null && changeValue.enum_type !== ""){
        let dictList = [];
        this.getDictList(changeValue.enum_type, dictList);
        console.log("-----------这里");
        console.log(changeValue.field_name.toString(),this.$refs[changeValue.field_name.toString()]);
      }
    },
    /**
     * 获取数据字典列表
