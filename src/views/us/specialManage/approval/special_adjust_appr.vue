  ...
  <div>
    <el-form ref="ruleForm" :model="Applys" :rules="rules" class="custom-common--form" label-width="190px">
        ...
        <el-row class="custom-common--footer">
          <el-button :disabled="submitLoading" size="small" type="primary" @click="mainApprAllowSubmit">{{$i18ns('通过')}} </el-button>
          <el-button :disabled="submitLoading" size="small" type="primary" @click="mainApprRejectSubmit">拒绝</el-button>
        </el-row>
      </el-form>
  </div>
</template>
