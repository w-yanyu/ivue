  ...
  <div class="page_content">
    ...
    <!-- <table class="tabel_balance">
      ...
      <tr class="tr_content" v-for="(itemData,index) in tableData"
        ...
        <td class="textAginleft">{{itemData.l_alias_name}}({{itemData.l_item_code}})</td>
    ...
    <el-table
      ...
      :row-style="isSelect"
    >
      <el-table-column type="index" :label="$i18ns('序号')" width="50" align="center"> </el-table-column>
      <el-table-column prop="l_alias_name" :label="$i18ns('项目')">
        <template slot-scope="scope">
          {{ scope.row.l_alias_name}}({{ scope.row.l_item_code}})
        </template>
      </el-table-column>

      <el-table-column prop="l_rowno" :label="$i18ns('行次')"  width="50" align="center">
      </el-table-column>

      <el-table-column prop="l_begin" :label="$i18ns('上期金额')">
        <template slot-scope="scope">
          <el-input-number class="table_content_input"  v-model="scope.row.l_begin" :disabled="true" :precision="2">
          </el-input-number>
        </template>
      </el-table-column>

      <el-table-column prop="l_end" :label="$i18ns('本期金额')">
        <template slot-scope="scope">
          <el-input-number class="table_content_input"  v-model="scope.row.l_end" :disabled="scope.row.l_form_ula!=''"
            :precision="2"></el-input-number>
        </template>
      </el-table-column>
    </el-table>
  ...
  export default {
    ...
    methods: {
      initData() {
        ...
        request_map["servicecode"] = "us0935";
        ...
        FileReader.prototype.readAsBinaryString = function(f) {
          ...
          reader.onload = function(e) {
            ...
            outdata.map(v => {
              ...
              //Excel没有删掉目录的接触
              obj.l_alias_name = v[_this.tabelName]
