  ...
  <div class="page_content">
   ...
   <div class="tabel_seach_bottom">
    ...
    <table border="1" class="horizontal_info">
      <tr>
        <td class="width12" colspan="6" >科目定义查询</td>
      </tr>
      <tr>
        <td class="width12">科目编号：</td>
        <td class="width12">
          <el-input class="table_content_input" v-model="subjectNum">
          </el-input>
        </td>

        <td class="width12">科目名称：</td>
        <td class="width12">
          <el-input class="table_content_input" v-model="subjectName">
          </el-input>
        </td>

        <td class="width12">科目类型：</td>
        <td class="width12">
          <el-select v-model="subjectType" placeholder="请选择..." class="table_select" >
            <el-option v-for="item in subjectData" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
      ...
      <tr>
        <td class="width12"  colspan="6"> 
          <span> 每页显示</span>
      <el-input class="page_input" v-model="pageNum">
      </el-input>
      <el-button class="table_seach_page" type="success"
      plain @click.native.prevent="seach">查询 </el-button></td>
      </tr>
    </table>


    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 95% " max-height="500" class="table-el"
      @selection-change="handleSelectionChange">
     <!-- <el-table-column type="selection" width="55">
      </el-table-column> -->
      <el-table-column label="科目编号 " width="120" align="center">
        <template slot-scope="scope">{{ scope.row.item_code }}</template>
      </el-table-column>
      <el-table-column prop="item_name" label="科目名称 " align="center">
      </el-table-column>
      <el-table-column prop="item_type" label="科目类型 " align="center" :formatter="itemTpFormat">
      </el-table-column>
      <el-table-column prop="parent_item_code" label="上级科目编号 " align="center">
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      initData() {
        ...
        request_map["servicecode"] = "us0900";
        request_map["item_code"] = that.subjectNum; //科目编号
        request_map["item_name"] = that.subjectName; //科目名称
        request_map["item_type"] = that.subjectType; //科目类型
