  ...
  export default {
    ...
    data() {
      return {
        ...
        // 损益
        profitLossUrl: "/views/us/financialManager/custReportDataManager/profitLoss_list.json",
        // 现金流量
        cashFlowUrl: "/views/us/financialManager/custReportDataManager/cashFlow_list.json",
