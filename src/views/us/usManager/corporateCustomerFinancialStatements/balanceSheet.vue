  ...
  <div class="page_content">
    ...
    <table class="tabel_balance">
      ...
      <tr class="tr_content" v-for="(itemData,index) in tableData"
        ...
        <td class="textAginleft" v-if="itemData.l_alias_na">{{itemData.l_alias_na}}({{itemData.l_item_cd}})</td>
        <td v-if="itemData.l_alias_na">{{itemData.l_rowno}}</td>
        <td v-if="itemData.l_alias_na">
        ...
        <td v-if="itemData.r_alias_na" class="textAginleft">{{itemData.r_alias_na}}({{itemData.r_item_cd}})</td>
        <td v-if="itemData.r_alias_na">{{itemData.r_rowno}}</td>
        <td v-if="itemData.r_alias_na">
          <!-- <el-input class="table_content_input" v-model="itemData.r_begin" :disabled="true">
          </el-input> -->
          <el-input-number class="table_content_input" v-model="itemData.r_begin" :disabled="true" :precision="2">
          </el-input-number>
        </td>
        <td v-if="itemData.r_alias_na">
          ...
          <el-input-number class="table_content_input" v-model="itemData.r_end" :disabled="itemData.r_form_ula!=''"
            :precision="2"></el-input-number>
        </td>
      </tr>
  ...
  export default {
    ...
    data() {
      return {
        ...
        formulaData: [], //含有公式的数组
        importUrl: '/views/us/usManager/corporateCustomerFinancialStatements/importUrl.json',
    ...
    methods: {
      initData() {
        ...
        request_map["servicecode"] = "ISMTCTST2164";
      ...
      itemRInput(item) {
        ...
        if (item.r_item_cd !== '') {
          let modifyArray = that.seachMachArry(item.r_item_cd, item.r_end);
          console.log('  console.log("需要修改的数组", that.tableData[modifyArray[i].index]);', modifyArray);
          that.$nextTick(() => {
            for (let i in modifyArray) {
              if (modifyArray[i].side === 'l') {
                that.tableData[modifyArray[i].index].l_end = modifyArray[i].totalValue
        ...
        FileReader.prototype.readAsBinaryString = function(f) {
          ...
          reader.onload = function(e) {
            ...
            outdata.map(v => {
              ...
              obj.r_alias_na = v['__EMPTY_4']
              obj.r_rowno = v['__EMPTY_5']
              obj.r_item_cd = v['__EMPTY_6']
