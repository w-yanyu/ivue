<template>
  <div class="page_content">
    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100% " max-height="150"
      ...
      <el-table-column label="抵质押品编号 " width="120" align="center">
        <template slot-scope="scope">{{ scope.row.colt_ppsl_id }}</template>
      </el-table-column>
      <el-table-column prop="colt_type" label="押品类型 " align="center">
      </el-table-column>
      <el-table-column prop="colt_type_name" label="押品类型名称" align="center">
      </el-table-column>
      <el-table-column prop="colt_prod_cd" label="押品产品 " align="center">
      </el-table-column>
       <el-table-column prop="colt_prod_name" label="押品产品名称" align="center">
      </el-table-column>
      <el-table-column prop="cust_no" label="抵质押人 " align="center">
      </el-table-column>
