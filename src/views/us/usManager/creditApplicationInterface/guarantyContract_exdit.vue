    ...
    <div class="menu-form--container">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="130px" class="custom-common--form">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="合同金额（折算基准币种）" prop="guar_base_amt" label-width="203px">
              <el-input class="input_el" v-model.number="ruleForm.guar_base_amt" @blur="guarBaseAmtInput($event)" type="number">
              </el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row class="menu-footer">
          <el-col :span="24">
            <el-button type="primary" @click="clickConfirm">修改</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      initData() {
        ...
        request_map["servicecode"] = "ICMSLNTS5749";
          ...
          .then((response) => {
            ...
            if (response.code === "200") {
              ...
              for (let i in that.tableData) {
                if (
                  that.tableData[i].guar_ctr_ppsl_id !== "" &&
                  that.tableData[i].guar_ctr_ppsl_id !== null
                ) {
                  console.log(
                    "guar_ctr_ppsl_id",
                    that.tableData[i].guar_ctr_ppsl_id
      ...
      clickConfirm() {
        ...
        request_map["servicecode"] = "ICMSLNTS5800";
        request_map["appl_id"] = that.cParentParams.appl_id;
