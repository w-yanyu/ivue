  ...
  <div>
      <el-form ref="ruleForm" :model="Applys" :rules="rules" class="custom-common--form" label-width="190px">
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="授信总金额" prop="appv_busi_amt">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="综合授信金额" prop="appv_synt_busi_amt">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="专项授信金额" prop="appv_spec_busi_amt">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="集团/非集团授信标志" prop="single_group_flag">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="低风险授信金额" prop="appv_lowr_busi_amt">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="是否我行关联方" prop="is_hf_rela">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="是否绿色信贷(银监2018)" prop="is_greenloan_cbrc">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="是否绿色信贷(人行)" prop="is_greenloan_hude">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="是否绿色信贷(银监2020)" prop="is_greenloan_cbrctt">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="是否政府购买服务标识" prop="is_buy_service_flag">
          ...
          <el-col :span="8">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="是否企业周转便利金融工具" prop="bljrgj">
          ...
          <el-col :span="24">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="授信资金用途" prop="ln_purpose_desc">
              <el-input v-model="Applys.ln_purpose_desc"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item :rules="[{ required: true, message: '此项为必填项' }]" class="upload-item" label="授信申请方案综述" prop="cl_group_desc">
...
export default {
  ...
  data() {
    return {
      ...
      toRequest:  "/views/us/usManager/creditApply/query/subCredit/sub_customer_main_apply.json",
      ccy_cdList: [],//币种类型字典
      yes_noList:[],//是否标志字典
