...
export default {
  ...
  data() {
    return {
      ...
      dialogWidth: "60%",
      activeName: "A1",
      toCreditAllocationUrl: "/views/us/usManager/creditApply/query/subCredit/sub_creditAllocation_list.json",
      toRequest: "/views/us/usManager/creditApply/query/group_customer_main_apply.json",
      ccy_cdList: [],//币种类型字典
      class_cdList: [], //分类类型字典
      tabList: [], // tab切换列表
      routidSelect: false,
