...
export default {
  ...
  mounted(){
    ...
    let getGropid = {
      servicecode: "IUMSCUTS1053",
      cust_no: this.cParentParams.cust_no
    }
    this.$http.invokeAPI(init_url, "post", getGropid)
    .then(response1 => {
      console.log(response1);
      if(response1.code="200"){
        let init_req = {
              servicecode: "IUMSCUTS1054",
              cust_no: response1.data.gropid
            }
      ...
      console.log("gropid ===== " + this.gropid);
    });
