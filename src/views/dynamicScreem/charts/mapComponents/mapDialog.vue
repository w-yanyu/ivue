    ...
    <div class="dialog-outside">
      <div class="dialog-content">
        <div class="info-title">
          {{ topTableTitle }} <span class="info-unit">{{ $i18ns('digitalScreen.map_unit') + ':' + tableUnit }}</span>
        </div>
        ...
        <div class="info-title">
          {{ middleTableTitle }} <span class="info-unit">{{ $i18ns('digitalScreen.map_unit') + ':' + tableUnit }}</span>
        </div>
        <div class="mapMiddleNumber">
          <p
        ...
        <div class="info-title">
           {{ bottomTableTitle }}<span class="info-unit">{{ $i18ns('digitalScreen.map_unit') + ':' + tableUnit }}</span>
        </div>
        <div class="mapMiddleNumber">
          <p
