        ...
        <el-form ref="ruleForm" :model="ruleForm" label-width="160px" class="custom-common--form">
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form-item label="还款方式">
                  <el-input v-model="ruleForm.loanInfo.repayType" :disabled="true"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
          ...
          <el-collapse-item name="14">
            ...
            <el-table
             :data="videosList"
            >
              <el-table-column prop="fileName" label="附件类型"></el-table-column>
              <el-table-column label="是否合规">
                  <template slot-scope="scope">
                    <el-radio v-model="scope.row.isCompliant" label="Y">是</el-radio>
                    <el-radio v-model="scope.row.isCompliant" label="N">否</el-radio>
                  </template>
                </el-table-column>
            </el-table>
            <el-row class="videos-btns">
              <el-button @click="handleCompliant('Y')">全部合规</el-button>
              <el-button @click="handleCompliant('N')">全部不合规</el-button>
            </el-row>
          </el-collapse-item>
          <el-collapse-item name="15" disabled>
            <template slot="title">
              <span>
                <em></em>审批结果
              </span>
...
export default {
  ...
  data() {
    return {
      ...
      relevantList: ["认领记录", "学历学籍信息查询", "审批历程信息", "人工审批结果", "退补件历史", "身份证信息"], // 相关资料列表
  ...
  methods: {
    ...
    handleInfo() {
      ...
      switch (this.cParentParams.currAprovRole) {
        ...
        case "DATA_VERYF":
        case "DATA_VERYI":
          this.relevantList = ["认领记录"];
          break;
        case "DATA_VERYC":
        case "DATA_VERYH":
          this.relevantList = ["认领记录", "确权模板"];
        default:
          break;
      }
    },
