                ...
                <el-row>
                  <el-col :span="24">
                    <el-form-item label=" ">
                      ...
                      <el-checkbox v-model="artificialSign" v-if="submitForm.commitType === 'PASS'">是否人工加签</el-checkbox>
                    </el-form-item>
                  </el-col>
  ...
  computed: {
    ...
    roleBackReviewList() {
      ...
      return this.backReviewList.filter(item => {
        if (bklist.indexOf(item.dictId) > -1) {
          return true;
        }
        return false;
      })
      ...
      this.$refs.submitForm.validate(valid => {
        if (valid) {
          ...
          switch (params.commitType) {
            case "PASS":
              if(this.artificialSign){
                params.artificialSign = 'Y';
              }else{
                params.artificialSign = 'N';
              }
              break;
            case "REJECT":
