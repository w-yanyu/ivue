    ...
    <div class="todo-top">
      ...
      <el-tabs v-model="activeName" type="card">
        <el-tab-pane v-for="(item, index) in tabList" :key="index" :label="item.mytitle" :name="item.idField">
          <pte-resolver v-if="activeName === item.idField" :c-parent-meta="c_$meta" :c-parent-scope="c_$scope"
  ...
  methods: {
      ...
      MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
        .then((res) => {
          if (res && res.code === "200") {
            ...
            console.log("++++++++++++---看这里",that.c_$params.crdlno);
            console.log("++++++++++++---看这里2",this.c_$params.crdlno);
    ...
    getRoadList() {
      let params = {
        ...
        servicecode: "AS_COLS_BPM_LSROUT",
      };
      MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
        .then((res) => {
          if (res && res.code === "200") {
      ...
      this.$refs.ruleForm.validate((valid) => {
        if (valid) {
          let params = {
            ...
            servicecode: "AS_COLS_BPM_COMTSK",
          };
