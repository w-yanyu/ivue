<template>
 <div class='all_div'>
   <div class='title'><span class="bl"></span><span class='span-title'>{{$i18ns('T302.Limit-Opt-Record')}}</span></div>
    <div class="table_wh">
    <to-json toUrl="/views/uccp/quotaManager/quotaVeiw/components/LimitOperationRecord/uccp_opt_detail_list.json" :params="this.params">
        </to-json>
        </div>
 </div>
</template>
