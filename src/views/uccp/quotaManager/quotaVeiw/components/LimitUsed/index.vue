<template>
 <div class='all_div'>
   <div class='title'><span class="bl"></span><span class='span-title'>{{$i18ns('T302.Occupancy-record')}}</span></div>
    <div class="table_wh">
    <to-json toUrl="/views/uccp/quotaManager/quotaVeiw/components/LimitUsed/occup_info.json"
    :params="this.params">
        </to-json>
        </div>
 </div>
...
import MyAxios from "pte-ui/utils/MyAxios";
  export default {
    ...
    created() {
        console.log("this.customeN--used", this.customeName);
        console.log("this.customeN--used", this.customeNo);
