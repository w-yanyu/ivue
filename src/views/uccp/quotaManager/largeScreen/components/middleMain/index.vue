<template>
  <div class="middle-main">
    ...
    <div class="circle-div">
      <div class="circle-div-item">
        <div class="circle-body">
          <div class="progress-div" id="custAvalTotal"></div>
      ...
      <div class="circle-div-item">
        <div class="circle-body">
          <div class="progress-div" id="assetAvalTotal"></div>
          <div class="circle-value">70%</div>
        </div>
        <div class="circle-title">
          <div>资方</div>
      ...
      <div class="circle-div-item">
        <div class="circle-body">
          <div class="progress-div" id="guarAvalTotal"></div>
          <div class="circle-value">70%</div>
        </div>
        <div class="circle-title">
          <div>担保方</div>
    ...
    <!-- 额度已使用比率 -->
    <div class="used-ratio">
      <div class="used-ratio-div">
        <div class="used-ratio-div-title">额度已使用比例</div>
        <div class="used-ratio-div-value">69.1%</div>
      </div>
      <div class="used-ratio-charts" id="used-ratio-charts"></div>
    </div>
  </div>
</template>
<script>
