<template>
  <div>
    ...
    <el-row>
      <el-col :span="12">
        <el-form label-width="100px " :rules="rules">
          <el-form-item label="限额总额" prop="limitAmount">
    ...
    <el-row>
      <el-col :span="12">
        <el-form label-width="100px " :rules="rules">
          <el-form-item label="控制方式" prop="limit_control_way">
            <el-select class="selectW" size="small" v-model="limit_control_way">
    ...
    <el-row v-if="limit_control_way == '0'">
      <el-col :span="12">
        <el-form label-width="100px " :rules="rules">
          <el-form-item label="监控频率" prop="amt_monitor_freq">
      ...
      <el-col v-if="amt_monitor_freq == '4'" :span="6">
        <el-form label-width="100px " :rules="rules">
          <el-form-item label="监控起始日" prop="starDate">
            <el-date-picker
              type="date"
              placeholder="选择日期"
              v-model="starDate"
      ...
      <el-col v-if="amt_monitor_freq == '4'" :span="6">
        <el-form label-width="100px " :rules="rules">
          <el-form-item label="监控终止日" prop="endDate">
            <el-date-picker
              type="date"
              placeholder="选择日期"
              v-model="endDate"
      ...
      <el-col v-if="amt_monitor_freq == '3'" :span="12">
        <el-form label-width="100px " :rules="rules">
          <el-form-item label="监控年份" prop="amt_monitor_range">
            <el-input
              size="small"
              :disabled="true"
      ...
      <el-col v-if="amt_monitor_freq == '2'" :span="12">
        <el-form label-width="100px " :rules="rules">
          <el-form-item label="监控季度" prop="amt_monitor_range">
      ...
      <el-col v-if="amt_monitor_freq == '1'" :span="12">
        <el-form label-width="100px " :rules="rules" prop="amt_monitor_range">
      ...
      <el-col v-if="amt_monitor_freq == '0'" :span="12">
        <el-form :rules="rules" label-width="100px ">
          <el-form-item prop="amt_monitor_range" label="监控天数">
            <el-input
              size="small"
              v-model="amt_monitor_range"
              placeholder="请输入具体天数"
    ...
    <el-row>
      <el-col :span="12">
        <el-form label-width="100px ">
          <el-form-item label="限额状态" prop="limit">
