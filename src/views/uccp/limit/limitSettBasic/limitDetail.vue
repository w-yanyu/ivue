<template>
  <div>
    ...
    <el-row>
      <el-col :span="12">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Limit_amount')">
            <el-input v-model="limitAmount" size="small" :disabled="true"></el-input>
          </el-form-item>
        </el-form>
      </el-col>
      <el-col :span="12">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Start_date')">
            <el-date-picker
              type="date"
              placeholder="选择日期"
              format="yyyyMMdd"
    ...
    <el-row>
      <el-col :span="12">
        <el-form label-width="100px">
          <el-form-item :label="$i18ns('T302.Limit_control_way')">
            <el-select class="selectW" size="small" v-model="limit_control_way" :disabled="true">
      ...
      <el-col :span="12">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Limit_measures')">
            <el-select class="selectW" size="small" v-model="measures" :disabled="true">
    ...
    <el-row v-if="limit_control_way == '0'">
      <el-col :span="12">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Limit_monitor_freq')">
            <el-select class="selectW" size="small" v-model="amt_monitor_freq" @change="nowtime" :disabled="true">
      ...
      <el-col v-if="amt_monitor_freq == '4'" :span="6">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Limit_monitor_startdt')" prop="name" :disabled="true">
            <el-date-picker
              type="date"
              placeholder="选择日期"
              v-model="starDate"
      ...
      <el-col v-if="amt_monitor_freq == '4'" :span="6">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Limit_monitor_enddt')" prop="name" :disabled="true">
            <el-date-picker
              type="date"
              placeholder="选择日期"
              v-model="endDate"
      ...
      <el-col v-if="amt_monitor_freq == '3'" :span="12">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Limit_monitor_year')" prop="name">
            <el-input
              size="small"
              :disabled="true"
      ...
      <el-col v-if="amt_monitor_freq == '2'" :span="12">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Limit_monitor_season')">
            <el-select class="selectW" size="small" v-model="season" :disabled="true">
              <el-option
      ...
      <el-col v-if="amt_monitor_freq == '1'" :span="12">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Limit_monitor_month')">
            <el-select class="selectW" size="small" v-model="mon" :disabled="true">
              <el-option
      ...
      <el-col v-if="amt_monitor_freq == '0'" :span="12">
        <el-form :rules="dayRules" label-width="100px ">
          <el-form-item prop="name" :label="$i18ns('T302.Limit_monitor_date')">
            <el-input
              size="small"
              v-model="amt_monitor_range"
              placeholder="请输入具体天数"
    ...
    <!-- <el-row>
      <el-col :span="12">
        <el-form label-width="100px ">
          <el-form-item label="有效标识" prop="name">
            <el-select class="selectW" size="small" v-model="limit" :disabled="true">
              <el-option
      ...
      <el-col :span="24">
        <el-form label-width="100px ">
          <el-form-item :label="$i18ns('T302.Limit_dimension')">
            <el-checkbox-group v-model="defCheck" @change="changeBox" :disabled="true">
              <el-checkbox
        ...
        <el-col :span="12">
          <el-form label-width="100px ">
            <el-form-item class="xiala" v-for="(item, index) in checkBox.dimension_list" :key="index"
              ...
              <el-select filterable multiple class="selectW" size="small" v-model="item.selected" @change="optionChange" :disabled="true"
               >
    ...
    <!-- <div>
      <to-json toUrl="/views/uccp/limit/limitSettBasic/limit_use_list.json" :params="params"></to-json>
    </div> -->
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    this.params.norm_no = this.cParentParams.norm_no; //限额编号
  ...
  methods: {
    ...
    initInfoData() {
      ...
      this.$http.invokeAPI(init_url, "post", init_req).then(response => {
        ...
        this.limitAmount = response.data.limit_total_amt? response.data.limit_total_amt.replace(
          /(\d{1,3})(?=(\d{3})+(?:$|\.))/g,
          "$1,"
        ):'';
        this.start_date = response.data.start_date;
        this.limit_control_way = response.data.limit_control_way;
