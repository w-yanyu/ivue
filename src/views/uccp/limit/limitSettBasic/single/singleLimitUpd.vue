      ...
      <el-col v-if="amt_monitor_freq == '2'" :span="12">
        <el-form label-width="100px ">
          <el-form-item label="监控季度">
            <el-select class="selectW" size="small" v-model="amt_monitor_range">
              <el-option
        ...
        <el-col :span="12">
          <el-form label-width="100px ">
            <el-form-item class="xiala" v-for="(item, index) in checkBox.dimension_list" :key="index"
              ...
              <el-select multiple filterable class="selectW" size="small" v-model="item.selected" @change="optionChange"
               >
