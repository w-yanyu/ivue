    ...
    <div class="Sidebar">
        <el-form :model="formdata" ref="formdata" :rules="rules" class="form-two-column">
            ...
            <el-form-item label="审批意见类型">
                <el-select v-model="formdata.appv_opinion_type" placeholder="请选择审批意见类型" disabled="true">
...
export default {
    ...
    methods: {
        ...
        onsubmit() {
            if (typeof this.formdata.opinion_define_id != 'undefined' && this.formdata.opinion_define_id != null && this.formdata.opinion_define_id !== '') {
                this.onsubmitUpd();
            }
            else {
                this.onsubmitAdd();
        ...
        onsubmitAdd() {
            let params = {
                ...
                task_define_id: this.formdata.task_define_id,
                wf_prod_no: this.formdata.wf_prod_no,
        ...
        onsubmitUpd() {
            let params = {
                servicecode: "bpm6003",
                opinion_define_id: this.formdata.opinion_define_id,
                opinion_define_name: this.formdata.opinion_define_name,
                opinion_belong: this.formdata.opinion_belong,
                appv_opinion_type: this.formdata.appv_opinion_type,
                opinion_desc: this.formdata.opinion_desc,
        ...
        queryTaskOpinion() {
            ...
            MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params)
                .then((res) => {
                    if (res && res.code === "200") {
                        if (typeof res.data.opinion_define_id != 'undefined' && res.data.opinion_define_id != null && res.data.opinion_define_id !== '') {
                            this.formdata.opinion_define_id = res.data.opinion_define_id;
                            this.formdata.opinion_define_name = res.data.opinion_define_name;
                            this.formdata.appv_opinion_type = res.data.appv_opinion_type;
                            this.formdata.opinion_belong = res.data.opinion_belong;
                            this.formdata.busi_type = res.data.busi_type;
                            this.formdata.task_define_id = res.data.task_define_id;
                            this.formdata.wf_prod_no = res.data.wf_prod_no;
                            this.formdata.opinion_desc = res.data.opinion_desc;
                        }
                    } else {
                        this.$message({
                            message: erortx,
    ...
    */
    ...
    created() {
        ...
        this.formdata.task_define_id = this.cParentParams.task_define_id;
        this.formdata.wf_prod_no = this.cParentParams.wf_prod_no;
        this.formdata.appv_opinion_type = this.cParentParams.appv_opinion_type;
        this.queryTaskOpinion();
        this.initParamList("COMM");
