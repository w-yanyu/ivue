      ...
      <div class="Sidebar">
        ...
        <el-form :model="formdata" ref="formdata" :rules="rules" class="form-two-column">
            <el-form-item label="审批意见定义名称">
                <el-input v-model="formdata.opinion_define_name" placeholder="请输入审批意见定义名称" maxlength="20" show-word-limit ></el-input>
            </el-form-item>
            ...
            <el-form-item label="审批意见详情" class="full-row">
                <el-input type="textarea" :rows="5" placeholder="请编辑审批意见详情" v-model="formdata.opinion_desc" maxlength="150" show-word-limit>
                </el-input>
            </el-form-item>
...
export default {
    ...
    created() {
            ...
            this.formdata.busi_type = this.cParentParams.busi_type,
            this.initParamList(this.cParentParams.busi_type),
            this.getDictList("BPM_E_OPINION_TYPE", "appv_opinion_list");
            this.formdata.opinion_define_id = this.cParentParams.opinion_define_id,
            this.formdata.opinion_define_name = this.cParentParams.opinion_define_name,
            this.formdata.appv_opinion_type = this.cParentParams.appv_opinion_type,
            this.formdata.opinion_desc_param = this.cParentParams.opinion_desc_param,
            this.formdata.opinion_desc = this.cParentParams.opinion_desc
    }
};
</script>
