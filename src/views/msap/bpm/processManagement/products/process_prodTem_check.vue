...
<div>
  <el-table
    ...
    :tree-props="{children: 'child_list', hasChildren: 'hasChildren'}">
     <el-table-column
      type="index" :label="$i18ns('bpmmodel.check_seq')"
      width="55">
    </el-table-column>
    <el-table-column    :label="$i18ns('bpmmodel.check_content')" width="400">
    ...
    <el-table-column  :label="$i18ns('bpmmodel.check_result')" width="100" align="center">
     <template slot-scope="scope">
       <span v-if="scope.row.check_flag==='1'">  
    ...
    <el-table-column  :label="$i18ns('bpmmodel.check_err_msg')">
      <template slot-scope="scope">
       <span v-if="scope.row.check_flag==='1'">
       <font color="#40E0D0">
       {{ scope.row.check_msg }} 
