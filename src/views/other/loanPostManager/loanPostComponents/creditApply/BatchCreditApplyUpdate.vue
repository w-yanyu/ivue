            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="申请原因描述" prop="reason">
                  <el-input type="textarea" :autosize="{minRows:2, maxRows: 5}" placeholder="请输入备注" v-model="batchCreditForm.reason"></el-input>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
