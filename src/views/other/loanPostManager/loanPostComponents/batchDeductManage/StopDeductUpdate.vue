            ...
            <el-row>
                <el-col :span="12">
                    <el-form-item  label="附件上传" prop="fileList">
                        <upload-file-view v-if="showComponent" ref="uploadProp" :uploadFileList="stopDeductForm.fileList" :uploadDisabled="false" @changeFile="changeUploadFile"></upload-file-view>
...
export default {
    ...
    reset(){
      this.$confirm("是否确认重置申请内容?", "提示", {
        ...
        this.stopDeductForm.stopBatchStart = "";  //停批起始时间
        this.stopDeductForm.stopBatchEnd = "";   //停批截止时间
        this.stopDeductForm.fileList = [];  //附件列表
        this.currentFileList = [];
        this.stopDeductForm.remark = "";  //备注
