      ...
      <el-collapse v-model="activeNames">
        ...
        <el-collapse-item name="3">
          ...
          <el-form :model="exceptForm" :rules="exceptRule" ref="exceptForm" class="search-form">
            <el-row v-for="(item, index) in exceptForm.locfnos" :key="index.abnormal_type" >
              <el-col :span="3">
                <el-form-item :label="item.abnormal_type" :prop="'locfnos.'+index+'.abnormal_type'"></el-form-item>
...
export default {
  ...
  methods: {
     ...
     */
    getAbnormalTypeList() {
      let a = this.cParentParams.abnormal_type.split(",");
      for (let i = 0; i < a.length; i++) {
        let obj = {};
        obj.abnormal_type = a[i];
        obj.remark = "";
        obj.isornot = "1";
        obj.batchnum = this.cParentParams.batchnum;
        obj.lncfno = this.cParentParams.lncfno;
        obj.credential = [];
        // obj.file_name = [];
        obj.idtfno= this.cParentParams.idtfno;
        this.exceptForm.locfnos.push(obj);
      }
    },
    /**
     * 异常类型数据字典转译
