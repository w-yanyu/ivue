  ...
  <div class="dialog_content">
    ...
    <div
      ...
      <div class="container-center">
        ...
        <!-- <el-button type="primary" v-if="showNum === (pageList.length - 1)" @click="submit">提交</el-button> -->
      </div>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    submit() {
      ...
      let params = {
        ...
        project_template_version: this.jsonParams.project_template_version,
    ...
    nextStep() {
      ...
      // this.stepSubmit(formData, servicecode);
      //执行表单校验
    ...
    // 添加属性
    addAttributte(item){
      this.jsonParams.protocol_template_version = item.protocol_template_version;
