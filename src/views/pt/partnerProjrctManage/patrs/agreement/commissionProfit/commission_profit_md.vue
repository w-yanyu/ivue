    ...
    <div class="main-container">
          ...
          <div>
            <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="120px" class="custom-common--form">
              <el-row>
                <el-col span="12">
                  <el-form-item label="合作方名称" prop="partner_name">
                    <el-input
                      placeholder="请选择合作方"
                ...
                <el-col :span="12">
                  <el-form-item label="合作方编号" prop="part_no" class="upload-item">
                    <el-input v-model="ruleForm.part_no"  disabled="true"></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="合作方式" prop="part_method">
                ...
                <el-col :span="12">
                  <el-form-item label="协议名称" prop="protocol_name" class="upload-item">
                    <el-input v-model="ruleForm.protocol_name" ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="协议有效状态" prop="protocol_status">
                ...
                <el-col :span="12">
                  <el-form-item label="生效日期" prop="effect_date" class="upload-item">
                    <el-date-picker
                ...
                <el-col :span="12">
                  <el-form-item label="失效日期" prop="expiry_date" class="upload-item">
                    <el-date-picker
                ...
                <el-col :span="12">
                  <el-form-item label="续签提示提前天数" prop="continued_day_advan" class="upload-item">
                    <el-input v-model="ruleForm.continued_day_advan" ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="原协议编号" prop="original_protocol_no" class="upload-item">
                    <el-input v-model="ruleForm.original_protocol_no" ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="是否敞口管控" prop="is_exposure_control">
                ...
                <el-col :span="12">
                  <el-form-item label="是否有保证金" prop="is_margin">
                ...
                <el-col :span="12">
                  <el-form-item label="是否分佣分润" prop="is_commission">
                ...
                <el-col :span="12">
                  <el-form-item label="协议地址1" prop="protocol_addr1" class="upload-item">
                    <el-input v-model="ruleForm.protocol_addr1" ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="协议地址2" prop="protocol_addr2" class="upload-item">
                    <el-input v-model="ruleForm.protocol_addr2" ></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="协议地址3" prop="protocol_addr3" class="upload-item">
  ...
  data() {
    return {
      ruleForm: {
        ...
        project_template_no: "",//项目模板id
        protocol_template_no:"",//协议模板id
        part_protocol_no:"",
        partner_name:"",//合作方名称
        part_no:"",
        part_method:"",//合作方式
