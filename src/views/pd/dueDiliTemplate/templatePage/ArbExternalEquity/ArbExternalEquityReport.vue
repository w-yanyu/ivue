  ...
  <div class="table_container">
    <div class="table_center">
      <el-row class="table_report">
        <el-col :span="24" class="table_header" style="border-bottom: 1px solid #5e6d82;">2、其他资产</el-col>
      </el-row>
      <el-row class="table_report">
        <el-col :span="24" class="table_header" style="">股权</el-col>
      </el-row>
      <el-row class="table_report">
