  ...
  <div class="table_container">
    <div class="table_center">
      <el-row class="table_report">
        <el-col :span="24" class="table_desc" style="border-top: 1px solid #5e6d82;"><b>{{$i18ns('(三)所有者权益项目重点分析')}}</b>
        </el-col>
      </el-row>
      <el-row class="table_report">
        <el-col :span="24" class="table_desc" style="border-top: 1px solid #5e6d82;">1、{{$i18ns('注册资本实际到位情况（如属于分期到位，应反映每期注册资本应到位的时间，各出资方应出资的金额，是否有注册资本不能按期到位的情况，并分析原因。）')}}
        </el-col>
      </el-row>
      <el-row class="table_report">
      ...
      <el-row class="table_report">
        <el-col :span="24" class="table_desc" >2、{{$i18ns('企业自身积累情况（分析资本公积和盈余公积的内容，盈余公积是否按规定提取，是否有亏损及亏损的弥补情况。）')}}
        </el-col>
      </el-row>
      <el-row class="table_report">
        <el-col :span="24" class="table_right page-desc">
