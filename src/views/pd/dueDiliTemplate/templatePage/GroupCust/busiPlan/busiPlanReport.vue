  ...
  <div class="table_container">
    <div class="table_center">
      <el-row class="table_report">
        <el-col :span="24" class="table_header" ><b>经营规划调查</b>
        </el-col>
      </el-row>
      <el-row class="table_report">
        <el-col :span="24" class="table_desc" style="border-top: 1px solid #5e6d82;">1、近期经营计划
        </el-col>
      </el-row>
      <el-row class="table_report">
      ...
      <el-row class="table_report">
        <el-col :span="24" class="table_desc" >2、远期发展战略
        </el-col>
      </el-row>
      <el-row class="table_report">
        <el-col :span="24" class="table_right page-desc">
      ...
      <el-row class="table_report">
        <el-col :span="24" class="table_desc" >3、企业文化战略
        </el-col>
      </el-row>
      <el-row class="table_report">
        <el-col :span="24" class="table_right page-desc">
