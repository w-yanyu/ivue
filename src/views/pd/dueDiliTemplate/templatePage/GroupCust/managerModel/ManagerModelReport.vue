  ...
  <div class="table_container">
    <div class="table_center">
      <el-row class="table_report">
        <el-col :span="24" class="table_header" ><b>管理者模式</b>
        </el-col>
      </el-row>
      <el-row class="table_report">
        <el-col :span="24" class="table_desc" style="border-top: 1px solid #5e6d82;">1、集团生产经营模式
        </el-col>
      </el-row>
      <el-row class="table_report">
      ...
      <el-row class="table_report">
        <el-col :span="24" class="table_desc" >2、集团财务管理模式
        </el-col>
      </el-row>
      <el-row class="table_report">
        <el-col :span="24" class="table_right page-desc">
      ...
      <el-row class="table_report">
        <el-col :span="24" class="table_desc" >3、集团决策管控模式
        </el-col>
      </el-row>
      <el-row class="table_report">
        <el-col :span="24" class="table_right page-desc">
