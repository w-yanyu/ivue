  ...
  <div class="table_container">
    <div class="table_center">
      <el-row class="table_report">
        <el-col :span="24" class="table_header" style="">七、结论性意见
        </el-col>
      </el-row>
      <el-row class="table_report">
      ...
      <el-row class="table_report">
        <el-col :span="8" class="bottom">
          客户经理签字:{{ page.acco_mana_sign }}
        </el-col>
        <el-col :span="8" class="bottom">
          电话号码:{{ page.telephone_number }}
        </el-col>
        <el-col :span="8" class="bottom" style="border-right: 1px solid #5e6d82;">
          签字日期:{{ page.sign_date }}
        </el-col>
      </el-row>
    </div>
