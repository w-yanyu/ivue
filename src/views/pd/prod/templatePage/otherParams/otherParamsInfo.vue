    ...
    <el-table :data="attTableData" border max-height="250">
      ...
      >
        <template slot-scope="scope">
          {{scope.row.attribute}}
<!--          <el-input v-model="scope.row.attribute" disabled="true"></el-input>-->
        </template>
      </el-table-column>
      <el-table-column
        prop="longname"
...
<!--      </div>-->
    ...
    <!-- 开关的属性添加 -->
    <!--    <el-dialog-->
    <!--      :title="$t('customNodeManage.switchProperties')"-->
    <!--      :close-on-click-modal="false"-->
    <!--      :visible.sync="switchPropertiesDialog"-->
    <!--      custom-class="dialog-medium"-->
    <!--    >-->
    <!--      <el-table :data="switchTableData" border>-->
    <!--        <el-table-column prop="switchValue" show-overflow-tooltip align="center">-->
    <!--          <template slot-scope="scope">-->
    <!--            <el-switch-->
    ...
    <!--      </el-table>-->
    <!--      <div slot="footer">-->
    <!--        <el-button type="primary" @click="switchOperationSave">-->
    <!--          {{-->
    <!--            $t("common.save")-->
    <!--          }}-->
    <!--        </el-button>-->
    <!--        <el-button @click="switchPropertiesDialog = false">-->
    <!--          {{-->
    <!--            $t("common.cancel")-->
    <!--          }}-->
    <!--        </el-button>-->
...
export default {
  ...
  created() {
    ...
    this.pageTranType = this.cParentParams.pageTranType;
    this.initTable();
  },
  watch: {
    oldAttTableData: {
  ...
  methods: {
    ...
    initTable() {
      ...
      let params = {
        ...
        pageTranType: that.pageTranType,
        servicecode: code
      };
      MyAxios.invokeAPI("/SUMP/icmcall/icmRPCCall", "post", params).then(res => {
        if (res && res.code === "200") {
