<template>    
    <div class="dialog" v-show="showMask">
        <div class="dialog-container">
            ...
            <slot name="c-form" class="c-form"></slot>
			<slot name="c-grid" class="c-grid"></slot>
            <div class="btns">
                <div v-if="cancel == 'true'" class="default-btn" @click="closeBtn">{{cancelText}}</div>
                <div v-if="danger == 'true'" class="danger-btn" @click="dangerBtn">{{dangerText}}</div>
                <div v-if="confirm == 'true'" class="confirm-btn" @click="confirmBtn">{{confirmText}}</div>
            </div>
...
.dialog .dialog-container .c-form {
	color: #797979;
	line-height: 26px;
	padding: 0 20px;
	box-sizing: border-box;
...
.dialog .dialog-container .c-grid {
	color: #797979;
	line-height: 26px;
	padding: 0 20px;
	box-sizing: border-box;
