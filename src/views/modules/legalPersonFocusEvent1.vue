                ...
                <tr v-for="(itemsubitem,index) in itemClass.children" :key="index">
                    ...
                    <td class="table-choose">
                        <div class="table-choose-div">
                            <el-radio v-model="itemsubitem.is_situation" label="1">是</el-radio>
                            <el-radio v-model="itemsubitem.is_situation" label="0">否</el-radio>
                        </div>
                    </td>
                </tr>
            </table>
        </div>
        <div class="item-tale" v-if="tempList.length===0">暂无相关数据，请稍后尝试</div>
...
export default {
    ...
    methods: {
        ...
        initData() {
            ...
            request_map["index_code"] = this.cParentParams.index_code ? this.cParentParams.index_code : 'attention_event';
