        ...
        .then((res) => {
          if (res && res.code === "200") {
            ...
            this.pushNode(
              "base_comp",
              that.$i18ns('基础部件'),
              "views/product/productModel/baseProduct/compEdit/base_component_attr.json"
            );
            this.pushNode(
              "loan_comp",
              that.$i18ns('放款部件'),
              "views/product/productModel/baseProduct/compEdit/lendg_component_attr.json"
            );
            this.pushNode(
              "prcg_comp",
              that.$i18ns('定价部件'),
              "views/product/productModel/baseProduct/compEdit/prcg_component_attr.json"
            );
            this.pushNode(
              "inst_comp",
              that.$i18ns('计息部件'),
              "views/product/productModel/baseProduct/compEdit/inst_cal_component_attr.json"
            );
            this.pushNode(
              "rpymt_comp",
              that.$i18ns('还款部件'),
              "views/product/productModel/baseProduct/compEdit/rpymt_component_attr.json"
            );
            this.pushNode(
              "matu_comp",
              that.$i18ns('到期部件'),
              "views/product/productModel/baseProduct/compEdit/matu_component_attr.json"
            );
            this.pushNode(
              "acctg_comp",
              that.$i18ns('核算部件'),
              "views/product/productModel/baseProduct/compEdit/busi_acctg_component_attr.json"
            );
            // 贴息标志
            if(res.data.subsd_int_flg === "1"){
              ...
              "subsd_int_comp",
              that.$i18ns('贴息部件'),
              "views/product/productModel/baseProduct/compEdit/subsd_int_component_attr.json"
            );
            }
            // 营销标志
            if(res.data.mktg_flg === "1"){
              ...
              "mktg_comp",
              that.$i18ns('营销部件'),
              "views/product/productModel/baseProduct/compEdit/mktg_component_attr.json"
            );
            }
            // 营改增标志
            if(res.data.prc_tax_seprtn_flg === "1"){
              ...
              "vat_comp",
              that.$i18ns('营改增部件'),
              "views/product/productModel/baseProduct/compEdit/vat_component_attr.json"
            );
            }
            // 联合贷标志
            if(res.data.union_loan_flg === "1"){
              ...
              "union_comp",
              that.$i18ns('联合贷部件'),
              "views/product/productModel/baseProduct/compEdit/union_component_attr.json"
            );
            }
            // 罚金标志
            if(res.data.fine_flg === "1"){
              ...
              "fine_comp",
              that.$i18ns('罚金部件'),
              "views/product/productModel/baseProduct/compEdit/fine_component_attr.json"
            );
            }
            // 费用标志
            if(res.data.fee_flg === "1"){
              ...
              "chrg_comp",
              that.$i18ns('费用部件'),
              "views/product/productModel/baseProduct/compEdit/chrg_component_attr.json"
            );
            }
            // 通知标志
            if(res.data.ntc_flg === "1"){
              ...
              "ntc_comp",
              that.$i18ns('通知部件'),
              "views/product/productModel/baseProduct/compEdit/ntc_component_attr.json"
            );
            }
            // 代理标志
            if(res.data.agnc_flg === "1"){
              ...
              "agnc_comp",
              that.$i18ns('代理部件'),
              "views/product/productModel/baseProduct/compEdit/agnc_component_attr.json"
            );
            }
            // 额度标志
            if(res.data.use_lmt_flg === "1"){
              ...
              "lmt_comp",
              that.$i18ns('额度部件'),
              "views/product/productModel/baseProduct/compEdit/lmt_component_attr.json"
            );
            }
            // 融通标志
            if(res.data.fincg_flg === "1"){
              ...
              "asset_asmt_comp",
              that.$i18ns('融通部件'),
              "views/product/productModel/baseProduct/compEdit/asset_asmt_component_attr.json"
            );
            }
            // 代偿标志
            if(res.data.asmpn_flg === "1"){
              ...
              "asmpn_comp",
              that.$i18ns('代偿部件'),
              "views/product/productModel/baseProduct/compEdit/asmpn_component_attr.json"
            );
            }
