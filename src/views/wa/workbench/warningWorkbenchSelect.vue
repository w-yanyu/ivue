...
export default {
  ...
  created() {
    ...
    console.log("---------"+ this.cParentParams.cust_no)
    ...
    this.c_$params.cust_id = this.cParentParams.cust_no; // cust_id参数传递
    this.c_$params.cust_name = this.cParentParams.case_cust_name;
    ...
    this.c_$params.wf_inst_id = this.cParentParams.proc_inst_id;
    console.log("wf_inst_id"+wf_inst_id)
  },
  methods: {
    /**
     * 获取头部信息
    ...
    getHeadInfo() {
      ...
      this.ruleForm.cust_name = this.cParentParams.case_cust_name
