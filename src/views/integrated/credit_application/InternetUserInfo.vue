        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="审核结果:"  prop="result" >
              <el-radio disabled  v-model="interForm.result" @change="resultChange" label="S">通过</el-radio>
              <el-radio disabled  v-model="interForm.result" @change="resultChange" label="F">拒绝</el-radio>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="拒绝原因:" v-show="isShowReject">
              <el-checkbox-group v-model="interForm.rejectResaion">
                <el-checkbox  v-for="(item,i) in reasionList" :key="i" :label="item.id" disabled>{{item.content}}</el-checkbox>
              </el-checkbox-group>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="审核备注:" prop="apdesc">
              <el-input type="textarea" :rows="4" v-model="interForm.memo" :disabled="true"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
