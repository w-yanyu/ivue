        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="授信金额(人民币)" prop="appv_busi_amt" label-width="150px">
              <el-input class="input_el" v-model.number="ruleForm.appv_busi_amt" @blur="appvBusiAmtInput($event)"
...
<!--          </el-col>-->
          ...
          <el-col :span="12">
            <el-form-item label="授信金额(折基准币种)" prop="base_busi_amt" label-width="150px">
              <el-input class="input_el" v-model.number="ruleForm.base_busi_amt" disabled type="number">
              </el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="申请起始日期: " prop="eff_dt" label-width="150px">
              ...
              <el-date-picker v-model="ruleForm.eff_dt" clearable format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                style="width: 100%" :picker-options="startDatePicker" :disabled="true" type="date"
          ...
          <el-col :span="12">
            <el-form-item label="申请终止日期: " prop="exp_dt" label-width="150px">
              ...
              <el-date-picker v-model="ruleForm.exp_dt" clearable format="yyyy-MM-dd" value-format="yyyy-MM-dd"
                style="width: 100%" :picker-options="endDatePicker" :disabled="true" type="date"
                @blur="datePickerBlur($event)">
              </el-date-picker>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="24">
            <el-form-item label="授信资金用途" prop="ln_purpose_desc" label-width="150px">
              <el-input class="input_el" v-model="ruleForm.ln_purpose_desc" disabled>
              </el-input>
            </el-form-item>
          </el-col>
        </el-row>
  ...
  export default {
    ...
    methods: {
        ...
        this.$http
          ...
          .then((response) => {
            if (response.code === "200") {
              ...
              that.ruleForm.base_busi_amt = response.data.base_busi_amt; //授信金额(折基准币种)
      ...
      appvBusiAmtInput(event) {
        ...
        that.ruleForm.base_busi_amt = value;
      },
