      ...
      <div class="center-div">
        <div class="withd-flex">
          ...
          >
            ...
            <el-form-item class="no_bg_bottom" prop="ui_language">
            ...
            <el-form-item class="loginbutton" v-if="false"> 
                <el-button
                  class="login-btn margin-t-8"
                  :loading="loading"
                  @click.native.prevent="goOtherLogin"
                  >{{ "通过风控系统" + $i18ns("logIn") }}</el-button
                >
              </el-form-item>
          </el-form>
        </div>
...
export default {
  ...
  created() {
    ...
    if (cookies_token && !sessionStorage.getItem("access_token")) {
